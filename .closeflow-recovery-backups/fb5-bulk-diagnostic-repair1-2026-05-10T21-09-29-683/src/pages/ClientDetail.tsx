                        ...
                        <article key={caseId || title} className="client-detail-case-smart-card" data-client-case-smart-card="true">
                          ...
                          <div className="client-detail-case-smart-actions">
                            ...
                            <EntityActionButton
                              ...
                              title="Usuń sprawę"
                              onClick={() = className={actionIconClass('danger', 'client-detail-icon-button client-detail-note-delete-action')} data-fb5-danger-source="note-trash"> toast.info('Usuwanie sprawy wymaga potwierdzenia w widoku sprawy.')}
                            >
                    ...
                    {getClientNotesForRender(getClientVisibleNotes(activities, client), clientPinnedNoteIds).map((note) => (
                      ...
                      >
                        <div className="client-detail-note-item-toolbar" data-client-note-actions="true">
                          ...
                          <EntityActionButton type="button" tone="danger" iconOnly title="Usuń notatkę" aria-label="Usuń notatkę" onClick={() = className={actionIconClass('danger', 'client-detail-icon-button client-detail-note-delete-action')} data-fb5-danger-source="note-trash"> handleDeleteClientNote(note)}>
