  ...
  if (isLoggedIn && user && isSupabaseEmailVerificationRequiredForUser(user)) {
    return (
      <TooltipProvider>
        ...
        <Toaster position="top-center" position="top-center" richColors closeButton />
      </TooltipProvider>
    );
  }
...
/* CLOSEFLOW_FB5_TOAST_DANGER_SOURCE: toast placement uses top-center and keeps richColors + closeButton. */

/* CLOSEFLOW_FB5_TOAST_TOP_CENTER_CONTRACT: app toasts use top-center, richColors and closeButton so Google Calendar notices do not cover action buttons. */
