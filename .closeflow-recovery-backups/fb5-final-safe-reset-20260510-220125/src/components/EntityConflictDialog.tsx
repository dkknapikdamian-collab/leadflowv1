            ...
            <div key={candidate.entityType + '-' + candidate.id} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                ...
                <div className="flex flex-wrap gap-2 md:justify-end">
                  ...
                  {onDeleteCandidate ? (
                    <Button type="button" variant="outline" size="sm" onClick={() => onDeleteCandidate(candidate)} disabled={busy} className={actionButtonClass('danger', 'cf-entity-conflict-delete-action')}>
