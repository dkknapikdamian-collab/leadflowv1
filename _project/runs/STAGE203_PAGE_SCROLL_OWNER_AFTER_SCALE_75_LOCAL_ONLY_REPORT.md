# STAGE203_PAGE_SCROLL_OWNER_AFTER_SCALE_75_LOCAL_ONLY_REPORT
...
- Stage201 ustawił kontrolowaną skalę 75%.
- Stage202 usunął tekst Najbliższe 7 dni / Najszybszy filtr i próbował dodać scroll na main.
- Damian potwierdził, że scroll nadal nie działa.
- Przy transform/scale scroll nie może być uwięziony w body/#root overflow hidden.
- Stage203 przenosi scroll owner na body/#root.
- Sidebar zostaje sticky i zachowuje pełną wysokość widoku.
- Main/view/cf-html-view nie blokują już długich widoków.
...
- Ctrl+F5.
- Sprawdzić czy strona przewija się w dół w kalendarzu tygodniowym i miesięcznym.
- Sprawdzić czy sidebar zostaje pełnej wysokości i nie tworzy fosy.
