# STAGE200D_REPAIR_ALL_CSS_MALFORMED_IMPORT_COMMENTS_LOCAL_ONLY_REPORT
...
- Stage200C nie wystarczył.
- W skrypcie Stage200C był błąd PowerShell przy zmiennej z dwukropkiem.
- Build nadal padał na malformed CSS import/comment.
- Stage200D naprawia wszystkie pliki CSS/SCSS w src, nie tylko src/index.css.
- Stage200D normalizuje sklejone linie typu: */ @import, * COMMENT @import, COMMENT @import.
- Zakazane legacy importy 80% zoom/density/sidebar pozostają wyłączone.

## WYNIK SKRYPTU

{   "changed": [     "src/index.css",     "src/styles/closeflow-vnext-ui-contract.css"   ],   "fixes": [     "src/index.css: normalized active import tailwindcss",     "src/index.css: normalized active import ./styles/closeflow-mobile-start-tile-trim.css",     "src/styles/closeflow-vnext-ui-contract.css: normalized active import ./styles/closeflow-vnext-ui-contract.css"   ],   "remainingBad": [] }

## TESTY

- node scripts/repair-stage200d-all-css-import-comments.cjs
