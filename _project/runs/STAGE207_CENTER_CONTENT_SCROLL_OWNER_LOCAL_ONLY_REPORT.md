# STAGE207_CENTER_CONTENT_SCROLL_OWNER_LOCAL_ONLY_REPORT
...
- Debug pokazał main-calendar-html height 998.84 przy viewport height 730.
- Treść jest dłuższa niż ekran.
- Scroll nie może być na body/browser.
- Scroll nie może ruszać sidebara ani global-bara.
- Layout ma main[data-shell-main=true], global-bar i div.view.active[data-shell-content=true].
- Stage207 wyłącza stare próby scrolla: Stage202, Stage203, Stage205, Stage206.
- Stage207 ustawia scroll tylko na div.view.active[data-shell-content=true].
- Skala 75% zostaje.
...
- npm run build
- npm run dev
- ręcznie: /calendar, /notifications, /activity, /ai-drafts, /tasks
...
- Sprawdzić, czy body/browser nie scrolluje.
- Sprawdzić, czy global-bar zostaje na miejscu.
- Sprawdzić, czy scrolluje tylko środkowy panel pod global-barem.
