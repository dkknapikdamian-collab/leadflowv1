# STAGE205_MAIN_ONLY_SCROLL_AFTER_SCALE_75_LOCAL_ONLY_REPORT
...
- Stage203 przywrócił scroll, ale scrollował cały ekran/body.
- Damian wskazał, że scroll ma dotyczyć tylko części aplikacji od lewego panelu.
- Layout ma oddzielny sidebar i main[data-shell-main=true].
- Stage205 usuwa import Stage203 z App.tsx.
- Stage205 robi body/html/root jako nieruchomy viewport.
- Stage205 ustawia main[data-shell-main=true] jako jedynego właściciela scrolla po stronie treści.
- Stage205 zachowuje skalę 75% ze Stage201.
...
- npm run build
- npm run dev
- ręcznie: /activity, /notifications, /ai-drafts, /calendar?view=week, /calendar?view=month
...
- Sprawdzić, czy scroll bar nie scrolluje body/całego ekranu.
- Sprawdzić, czy scroll działa tylko w panelu treści po prawej od sidebara.
- Sprawdzić, czy sidebar zostaje nieruchomy.
