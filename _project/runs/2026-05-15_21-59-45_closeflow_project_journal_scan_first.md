# Run report - CloseFlow Lead App - 2026-05-15_21-59-45

## FAKT
- Runner version: v6.
- App repo: C:\Users\malim\Desktop\biznesy_ai\2.closeflow
- App branch: dev-rollout-freeze
- App commit before this stage commit: fc549b3
- Obsidian vault: C:\Users\malim\Desktop\biznesy_ai\00_OBSIDIAN_VAULT
- Obsidian branch: main
- Obsidian commit before this stage commit: 8700046
- Stage type: project memory / journal / scan-first.
- UI changed: no.
- Routing changed: no.
...
- .env.vercel
- .gitignore
- 00_READ_FIRST_STAGE89_ACCEPTED_ADMIN_DEBUG_AND_LEAD_DETAIL.md
- 00_READ_FIRST_STAGE90_QA_SMOKE_PWA_DIGEST_PORTAL_BUTTON_MATRIX.md
- 00_READ_FIRST_STRIPE_SANDBOX_NAME_TODO.md
- AGENTS.md
- apply_hotfix_right_rail_dark_wrappers_and_push.ps1
- APPLY_OVERLAY.txt
- AUDYT_V1_2026-04-18.md
- components.json
- firebase-applet-config.json
- firebase.json
- firestore.rules
- index.html
- INSTRUKCJA_SUPABASE_STEP_1.txt
- metadata.json
- package-lock.json
- package.json
- PUSH_DO_GIT.txt
...
- README-WDROZENIE.md
- README.md
- README_HOTFIX_LEADS.md
- README_HOTFIX_RIGHT_RAIL_DARK_WRAPPERS.md
- README_PATCH_BUNDLE.txt
- README_ROOT_CAUSE.txt
- README_ROOT_CAUSE_SETTINGS.txt
- README_STAGE_2A.txt
- README_STAGE_2B_NOTES_CALENDAR.txt
- README_STAGE_3A.txt
- README_STAGE_SUPABASE_CUTOVER.txt
- README_WDROZENIE.md
- STATUS_ETAP_ACTIVITY_CASES_CLIENTS_CLEANUP.md
- STATUS_ETAP_AUTH_HOOK_CLEANUP.md
- STATUS_ETAP_AUTH_SNAPSHOT_EVENT_PACK.md
- STATUS_ETAP_BIG_PACK_SUPABASE.md
- STATUS_ETAP_CLIENTPORTAL_FIREBASEUTILS_CLEANUP.md
- STATUS_ETAP_LOGIN_SUPABASE_ONLY.md
- STATUS_ETAP_REMOVE_FIRESTORE_FROM_FIREBASE.md
- STATUS_ETAP_SUPABASE_AUTH_DECOUPLE.md
- STATUS_ETAP_SUPABASE_CONTEXT_FOLLOWUP.md
- STATUS_ETAP_WORKSPACE_FIRESTORE_CLEANUP.md
- STATUS_SUPABASE_KIERUNEK.md
- storage.rules
- SUPABASE_SQL_LEADS_HOTFIX_1.sql
- SUPABASE_SQL_LEGACY_FIRESTORE_IDS.sql
- SUPABASE_SQL_STEP_1.sql
- SUPABASE_SQL_STEP_2.sql
- SUPABASE_SQL_STEP_2A_CASE_PORTAL_ACTIVITY.sql
- tsconfig.json
...
- .github
- .stage10b_vercel_hobby_assistant_route_runner_repair_backup_20260506_074117
- .stage10c_assistant_route_collapse_resilient_backup_20260506_074607
- .stage19c_context_action_route_map_stage16_doc_repair_backup_20260506_134712
- .stage19_context_action_route_map_evidence_backup_20260506_112701
- .stage19_context_action_route_map_evidence_backup_20260506_112915
- .stage20b_context_action_verify_chain_repair_backup_20260506_135336
- .stage20_context_action_real_button_trigger_audit_backup_20260506_135051
- .stage21b_client_detail_feedback_repair_backup_20260507_215856
- .stage21_client_detail_feedback_backup_20260507_215658
- .stage26_backup_20260515105410
- .stage26_backup_20260515105725
- .stage5b_package_json_bom_build_gate_backup_20260506_071301
- .stage5_ai_read_query_hardening_v1_backup_20260506_070753
- .stage6b_stage6_doc_gate_repair_backup_20260506_071701
- .stage6d_gate_phrase_ascii_repair_backup_20260506_072318
- .stage6_ai_no_hallucination_data_truth_backup_20260506_071509
- .stage7b_payload_copy_repair_backup_20260506_072900
- .stage7_ai_assistant_query_api_contract_smoke_backup_20260506_072633
- .stage7_ai_assistant_query_api_contract_smoke_backup_20260506_072638
- .stage8_ai_assistant_ui_contract_client_backup_20260506_073249
- .stage9_ai_assistant_ui_smoke_prompts_backup_20260506_073518
- .stage9_ai_assistant_ui_smoke_prompts_backup_20260506_073601
- .vercel
- api
- artifacts
- docs
...
- check:operator-rail-stage5 = node scripts/check-operator-rail-stage5.cjs
- check:operator-rail-stage1 = node scripts/check-operator-rail-stage1.cjs
- check:today-header-actions-stack = node scripts/check-closeflow-today-header-actions-stack.cjs
...
- data:firestore:export = node scripts/export-firestore-data.cjs
- data:supabase:import = node scripts/import-supabase-data.cjs
- data:migration:a23:dry-run = node scripts/import-supabase-data.cjs
...
- repair:polish-text-global = node scripts/repair-polish-text-global.cjs
- check:polish-text-global = node scripts/check-polish-text-global.cjs
- sanitize:polish-text-reports = node scripts/sanitize-polish-text-reports.cjs
...
- smoke:critical-crud = node scripts/smoke-critical-crud.cjs
...
- stage90:write-env-smoke-evidence = node scripts/write-stage90-env-smoke-evidence.cjs
...
- stage90d:live-smoke = node scripts/stage90d-live-smoke.cjs
...
- smoke:stage18-context-action-runtime-contract = npm run audit:stage18-context-action-runtime-smoke
...
- check:final-qa-red-gates:collect = node scripts/collect-stage16k-final-qa-red-gates.cjs
- check:final-qa-failed-details:collect = node scripts/collect-stage16l-final-qa-failed-details.cjs
- check:stage16o:focused = node scripts/collect-stage16o-focused-final-qa.cjs
- check:stage16p:focused = node scripts/collect-stage16p-focused-final-qa.cjs
- check:stage16u:two-gates = node scripts/collect-stage16u-final-two-gates.cjs
- check:today-refresh-tiles-match-lists = node scripts/check-today-refresh-tiles-match-lists.cjs
- test:today-refresh-tiles-match-lists = node --test tests/today-refresh-tiles-match-lists.test.cjs
- check:unified-top-metric-tiles = node scripts/check-unified-top-metric-tiles.cjs
- test:unified-top-metric-tiles = node --test tests/unified-top-metric-tiles.test.cjs
- check:metric-tile-icons-next-to-value = node scripts/check-metric-tile-icons-next-to-value.cjs
- test:metric-tile-icons-next-to-value = node --test tests/metric-tile-icons-next-to-value.test.cjs
- check:today-view-customizer = node scripts/check-today-view-customizer.cjs
- test:today-view-customizer = node --test tests/today-view-customizer.test.cjs
- check:today-view-customizer-all-options = node scripts/check-today-view-customizer-all-options.cjs
- test:today-view-customizer-all-options = node --test tests/today-view-customizer-all-options.test.cjs
- check:eliteflow-metric-tiles = node scripts/check-eliteflow-metric-tile-lock.cjs
- check:package-json-no-bom = node scripts/check-package-json-no-bom.cjs
- check:eliteflow-final-metric-tiles = node scripts/check-eliteflow-final-metric-tiles.cjs
- check:eliteflow-metric-color-font-parity = node scripts/check-eliteflow-metric-color-font-parity.cjs
- check:eliteflow-tasks-tiles-text-clip-repair = node scripts/check-eliteflow-tasks-tiles-text-clip-repair.cjs
- check:admin-feedback-p1-hotfix = node scripts/check-admin-feedback-p1-hotfix.cjs
- check:admin-feedback-p1-followup = node scripts/check-admin-feedback-p1-followup.cjs
- check:today-section-click-repair = node scripts/check-today-section-click-repair.cjs
- check:today-top-tile-focus = node scripts/check-today-top-tile-focus.cjs
- check:ai-drafts-route-runtime-repair = node scripts/check-ai-drafts-route-runtime-repair.cjs
- check:stage21-client-feedback-layout = node scripts/check-stage21-client-detail-admin-feedback-layout.cjs
- check:stage21-client-detail-admin-feedback-layout = node scripts/check-stage21-client-detail-admin-feedback-layout.cjs
- check:stage22a-client-detail-feedback-ui-cleanup = node scripts/check-stage22a-client-detail-feedback-ui-cleanup.cjs
- check:stage23a-client-detail-cases-visibility-contrast = node scripts/check-stage23a-client-detail-cases-visibility-contrast.cjs
- check:stage24a-client-detail-actions-cases-roadmap = node scripts/check-stage24a-client-detail-actions-cases-roadmap.cjs
- check:stage25b-client-detail-feedback-complete-repair = node scripts/check-stage25b-client-detail-feedback-complete-repair.cjs
- check:stage25c-client-detail-guard-compat-final = node scripts/check-stage25c-client-detail-guard-compat-final.cjs
- check:stage25d-client-detail-jsx-build-fix = node scripts/check-stage25d-client-detail-jsx-build-fix.cjs
- check:stage26a-feedback-after-4ec-client-activity-ai-drafts = node scripts/check-stage26a-feedback-after-4ec-client-activity-ai-drafts.cjs
- check:stage27e-client-notes-event-final = node scripts/check-stage27e-client-notes-event-final.cjs
- check:stage27g-client-notes-id-runtime-final = node scripts/check-stage27g-client-notes-id-runtime-final.cjs
- check:stage28a-case-finance-core = node scripts/check-stage28a-case-finance-core.cjs
- check:stage28a3-case-finance-history-visible-repair = node scripts/check-stage28a3-case-finance-history-visible-repair.cjs
- check:stage29a-case-panel-notes-actions = node scripts/check-stage29a-case-panel-notes-actions.cjs
- check:closeflow-ui-skill-pack = node scripts/check-closeflow-ui-skill-pack.cjs
- audit:closeflow-ui-map = node scripts/audit-closeflow-ui-map.cjs
- check:closeflow-design-source-contract = node scripts/check-closeflow-design-source-contract.cjs
- audit:closeflow-style-map = node scripts/audit-closeflow-style-map.cjs
- check:closeflow-ui-premap-contract = node scripts/check-closeflow-ui-premap-contract.cjs
- check:closeflow-alert-severity-contract = node scripts/check-closeflow-alert-severity-contract.cjs
- check:closeflow-danger-style-contract = node scripts/check-closeflow-danger-style-contract.cjs
- check:closeflow-surface-contract = node scripts/check-closeflow-surface-contract.cjs
- check:closeflow-metric-icon-tone-contract = node scripts/check-closeflow-metric-icon-tone-contract.cjs
- check:closeflow-page-header-copy-contract = node scripts/check-closeflow-page-header-copy-contract.cjs
- check:closeflow-list-row-contract = node scripts/check-closeflow-list-row-contract.cjs
- check:closeflow-entity-action-placement-contract = node scripts/check-closeflow-entity-action-placement-contract.cjs
- check:closeflow-form-action-footer-contract = node scripts/check-closeflow-form-action-footer-contract.cjs
- check:closeflow-card-readability-contract = node scripts/check-closeflow-card-readability-contract.cjs
- check:closeflow-ui-contract-audit-stage8 = node scripts/check-closeflow-ui-contract-audit-stage8.cjs
- check:closeflow-today-stable-severity-contract = node scripts/check-closeflow-today-stable-severity-contract.cjs
- check:closeflow-notifications-severity-contract = node scripts/check-closeflow-notifications-severity-contract.cjs
- check:closeflow-calendar-activity-severity-contract = node scripts/check-closeflow-calendar-activity-severity-contract.cjs
- check:closeflow-leads-tasks-status-contract = node scripts/check-closeflow-leads-tasks-status-contract.cjs
- check:closeflow-today-stable-remaining-severity-contract = node scripts/check-closeflow-today-stable-remaining-severity-contract.cjs
- check:closeflow-legacy-today-route-contract = node scripts/check-closeflow-legacy-today-route-contract.cjs
- check:closeflow-active-legacy-color-contract = node scripts/check-closeflow-active-legacy-color-contract.cjs
- check:closeflow-admin-feedback-visual-repair = node scripts/check-closeflow-admin-feedback-visual-repair.cjs
- check:closeflow-metric-visual-parity-contract = node scripts/check-closeflow-metric-visual-parity-contract.cjs
- check:stage16a-v10-no-bom-mojibake = node scripts/check-stage16a-v10-no-bom-mojibake.cjs
- check:closeflow-visual-qa-stage16b = node scripts/check-closeflow-visual-qa-stage16b.cjs
- check:closeflow-dashboard-calendar-color-contract = node scripts/check-closeflow-dashboard-calendar-color-contract.cjs
- check:closeflow-final-active-ui-contract-audit = node scripts/check-closeflow-final-active-ui-contract-audit.cjs
- check:closeflow-detail-action-visual-qa = node scripts/check-closeflow-detail-action-visual-qa.cjs
- check:closeflow-mobile-parity-contract = node scripts/check-closeflow-mobile-parity-contract.cjs
- check:closeflow-ui-cleanup-release-evidence = node scripts/check-closeflow-ui-cleanup-release-evidence.cjs
- check:closeflow-stage16c-tasks-cases-visual-mobile-repair = node scripts/check-closeflow-stage16c-tasks-cases-visual-mobile-repair.cjs
- check:closeflow-stage16d-tasks-metric-final-lock = node scripts/check-closeflow-stage16d-tasks-metric-final-lock.cjs
- check:closeflow-client-event-modal-runtime-repair = node scripts/check-closeflow-client-event-modal-runtime-repair.cjs
- audit:closeflow-ui-map-inventory-v1 = node scripts/audit-closeflow-ui-map-inventory-v1.cjs
- check:closeflow-ui-map-inventory-v1 = node scripts/check-closeflow-ui-map-inventory-v1.cjs
- build:closeflow-ui-semantic-contract-v1 = node scripts/build-closeflow-ui-semantic-contract-v1.cjs
- check:closeflow-ui-semantic-contract-v1 = node scripts/check-closeflow-ui-semantic-contract-v1.cjs
- build:closeflow-ui-semantic-icon-baseline-v1 = node scripts/build-closeflow-ui-semantic-icon-baseline-v1.cjs
- check:closeflow-ui-semantic-icon-v1 = node scripts/check-closeflow-ui-semantic-icon-v1.cjs
- check:closeflow-lead-hidden-duplicate-restore-v1 = node scripts/check-closeflow-lead-hidden-duplicate-restore-v1.cjs
- check:lead-client-conflict-resolution-v1 = node scripts/check-lead-client-conflict-resolution-v1.cjs
- check:closeflow-lead-company-not-null-repair-v2 = node scripts/check-closeflow-lead-company-not-null-repair-v2.cjs
- check:vercel-hobby-function-limit = node scripts/check-vercel-hobby-function-limit.cjs
- check:closeflow-entity-conflicts-system-route-v1 = node scripts/check-closeflow-entity-conflicts-system-route-v1.cjs
- check:closeflow-system-route-conflicts-runtime-v1 = node scripts/check-closeflow-system-route-conflicts-runtime-v1.cjs
- check:closeflow-system-route-conflicts-runtime-repair-v2 = node scripts/check-closeflow-system-route-conflicts-runtime-repair-v2.cjs
- check:closeflow-supabase-fallback-named-exports-v1 = node scripts/check-closeflow-supabase-fallback-named-exports-v1.cjs
- check:closeflow-conflict-runtime-stabilization-hard-reset-v6 = node scripts/check-closeflow-conflict-runtime-stabilization-hard-reset-v6.cjs
- check:closeflow-typescript-stabilization-v7 = node scripts/check-closeflow-typescript-stabilization-v7.cjs
- check:closeflow-typescript-stabilization-v9 = node scripts/check-closeflow-typescript-stabilization-v9.cjs
- check:closeflow-conflict-delete-company-not-null-v25 = node scripts/check-closeflow-conflict-delete-company-not-null-v25.cjs
- check:closeflow-conflict-delete-company-not-null-v27 = node scripts/check-closeflow-conflict-delete-company-not-null-v27.cjs
- check:closeflow-client-case-settlement-v29 = node scripts/check-closeflow-client-case-settlement-v29.cjs
- check:closeflow-client-case-settlement-v30 = node scripts/check-closeflow-client-case-settlement-v30.cjs
- check:closeflow-client-case-settlement-v31 = node scripts/check-closeflow-client-case-settlement-v31.cjs
- audit:closeflow-visual-system-inventory = node scripts/audit-closeflow-visual-system-inventory.cjs --write
- check:closeflow-visual-system-inventory = node scripts/check-closeflow-visual-system-inventory.cjs
- check:a1-client-note-event-lead-visibility-finalizer = node scripts/check-closeflow-a1-client-note-event-lead-visibility-finalizer.cjs
- check:a2-duplicate-warning-ux-full = node scripts/check-closeflow-duplicate-warning-ux-full.cjs
- check:closeflow-design-system-tokens = node scripts/check-closeflow-design-system-tokens.cjs
- check:closeflow-duplicate-warning-ux-full = node scripts/check-closeflow-duplicate-warning-ux-full.cjs
- check:closeflow-wide-syntax-gate = node scripts/check-closeflow-wide-syntax-gate.cjs
- check:closeflow-action-icon-registry = node scripts/check-closeflow-action-icon-registry.cjs
- check:closeflow-vs2c1-action-icons-components = node scripts/check-closeflow-vs2c1-action-icons-components.cjs
- check:closeflow-visual-system-baseline-after-vs2c2 = node scripts/check-closeflow-visual-system-baseline-after-vs2c2.cjs
- check:closeflow-semantic-visual-registry = node scripts/check-closeflow-semantic-visual-registry.cjs
- verify:closeflow-visual-system-safe-baseline = npm.cmd run check:closeflow-action-icon-registry && npm.cmd run check:closeflow-vs2c1-action-icons-components && npm.cmd run check:closeflow-entity-icon-registry && npm.cmd run check:closeflow-visual-system-baseline-after-vs2c2 && npm.cmd run check:closeflow-semantic-visual-registry
- check:closeflow-css-import-order = node scripts/check-closeflow-css-import-order.cjs
- verify:closeflow-css-import-order = npm.cmd run check:closeflow-css-import-order && npm.cmd run build
- audit:closeflow-active-screen-layout-matrix = node scripts/audit-closeflow-active-screen-layout-matrix.cjs
- check:closeflow-active-screen-layout-matrix = node scripts/check-closeflow-active-screen-layout-matrix.cjs
- verify:closeflow-active-screen-layout-matrix = npm.cmd run audit:closeflow-active-screen-layout-matrix && npm.cmd run check:closeflow-active-screen-layout-matrix
- audit:closeflow-metric-tiles-final-migration = node scripts/audit-closeflow-metric-tiles-final-migration.cjs
- check:closeflow-metric-tiles-final-migration = node scripts/check-closeflow-metric-tiles-final-migration.cjs
- verify:closeflow-metric-tiles-final-migration = npm.cmd run audit:closeflow-metric-tiles-final-migration && npm.cmd run check:closeflow-metric-tiles-final-migration
- check:closeflow-metric-tiles-real-parity-repair = node scripts/check-closeflow-metric-tiles-real-parity-repair.cjs
- verify:closeflow-metric-tiles-real-parity = npm run check:closeflow-metric-tiles-real-parity-repair && npm run check:closeflow-metric-tiles-final-migration
- audit:closeflow-action-clusters-final-contract = node scripts/audit-closeflow-action-clusters-final-contract.cjs
- check:closeflow-action-clusters-final-contract = node scripts/check-closeflow-action-clusters-final-contract.cjs
- verify:closeflow-action-clusters-final-contract = npm.cmd run audit:closeflow-action-clusters-final-contract && npm.cmd run check:closeflow-action-clusters-final-contract
- check:closeflow-metric-tile-single-source-truth = node scripts/check-closeflow-metric-tile-single-source-truth.cjs
- verify:closeflow-metric-tile-single-source-truth = npm.cmd run check:closeflow-metric-tile-single-source-truth && npm.cmd run check:closeflow-metric-tiles-real-parity-repair && npm.cmd run check:closeflow-metric-tiles-final-migration
- audit:closeflow-metric-tiles-deep-source-map = node scripts/audit-closeflow-metric-tiles-deep-source-map.cjs
- check:closeflow-metric-tiles-deep-source-map = node scripts/check-closeflow-metric-tiles-deep-source-map.cjs
- verify:closeflow-metric-tiles-deep-source-map = npm.cmd run audit:closeflow-metric-tiles-deep-source-map && npm.cmd run check:closeflow-metric-tiles-deep-source-map
- check:closeflow-metric-tile-visual-source-truth = node scripts/check-closeflow-metric-tile-visual-source-truth.cjs
- verify:closeflow-metric-tile-visual-source-truth = npm.cmd run check:closeflow-metric-tile-visual-source-truth && npm.cmd run check:closeflow-metric-tile-single-source-truth && npm.cmd run check:closeflow-metric-tiles-real-parity-repair && npm.cmd run check:closeflow-metric-tiles-deep-source-map
- check:closeflow-operator-metric-tiles = node scripts/check-closeflow-operator-metric-tiles.cjs
- check:closeflow-operator-metric-tone-parity = node scripts/check-closeflow-operator-metric-tone-parity.cjs
- check:closeflow-metric-tiles-final-system = node scripts/check-closeflow-metric-tiles-final-system.cjs
- check:vs6-forms-modals-unification = node scripts/check-vs6-forms-modals-unification.cjs
- check:vs7-semantic-metric-tones = node scripts/check-vs7-semantic-metric-tones.cjs
- check:closeflow-screen-placement-slots = node scripts/check-closeflow-screen-placement-slots.cjs
- check:closeflow-screenshot-qa-evidence = node scripts/check-closeflow-screenshot-qa-evidence.cjs
- check:closeflow-screenshot-qa-contract = node scripts/check-closeflow-screenshot-qa-evidence.cjs --contract-only
- check:closeflow-no-local-visual-drift = node scripts/check-closeflow-no-local-visual-drift.cjs
- check:closeflow-no-direct-entity-icons = node scripts/check-closeflow-no-direct-entity-icons.cjs
- check:closeflow-no-unclassified-css-imports = node scripts/check-closeflow-no-unclassified-css-imports.cjs
- check:closeflow-no-local-finance-panels = node scripts/check-closeflow-no-local-finance-panels.cjs
- verify:closeflow-visual-system = npm.cmd run check:closeflow-screen-placement-slots && npm.cmd run check:closeflow-screenshot-qa-contract && npm.cmd run check:closeflow-no-local-visual-drift && npm.cmd run check:closeflow-no-direct-entity-icons && npm.cmd run check:closeflow-no-unclassified-css-imports && npm.cmd run check:closeflow-no-local-finance-panels
- check:client-detail-id-route-hotfix = node scripts/check-client-detail-id-route-hotfix.cjs
- check:closeflow-fin5-import-parser-repair3 = node scripts/check-closeflow-fin5-import-parser-repair3.cjs
- check:closeflow-case-settlement-panel = node scripts/check-closeflow-case-settlement-panel.cjs
- check:closeflow-fin5-bulk-imports = node scripts/check-closeflow-fin5-bulk-imports.cjs
- check:closeflow-fin5-bulk-imports-repair2 = node scripts/check-closeflow-fin5-bulk-imports-repair2.cjs
- check:closeflow-fin5-bulk-imports-repair3 = node scripts/check-closeflow-fin5-bulk-imports-repair3.cjs
- check:closeflow-fin5-bulk-imports-repair4 = node scripts/check-closeflow-fin5-bulk-imports-repair4.cjs
- check:closeflow-fin5-bulk-imports-repair5 = node scripts/check-closeflow-fin5-bulk-imports-repair5.cjs
- check:closeflow-import-boundaries-deep = node scripts/check-closeflow-import-boundaries-deep.cjs
- check:closeflow-tsc-first-errors = node scripts/check-closeflow-tsc-first-errors.cjs
- check:closeflow-vercel-hobby-functions-deep = node scripts/check-closeflow-vercel-hobby-functions-deep.cjs
- check:closeflow-fin5-heavy-qa-gates = node scripts/check-closeflow-fin5-heavy-qa-gates.cjs
- check:closeflow-fin5-import-boundaries-final = node scripts/check-closeflow-fin5-import-boundaries-final.cjs
- check:closeflow-fin5-preamble-syntax-final = node scripts/check-closeflow-fin5-preamble-syntax-final.cjs
- check:closeflow-fin5-syntax-rescue-final = node scripts/check-closeflow-fin5-syntax-rescue-final.cjs
- check:closeflow-fin5-syntax-rescue-pathspec-repair2 = node scripts/check-closeflow-fin5-syntax-rescue-pathspec-repair2.cjs
- check:closeflow-fin5-encoding-cleanup-final = node scripts/check-closeflow-fin5-encoding-cleanup-final.cjs
- check:closeflow-fin5-byte-encoding-repair = node scripts/check-closeflow-fin5-byte-encoding-repair.cjs
- check:closeflow-api0-vercel-hobby-functions = node scripts/check-closeflow-api0-vercel-hobby-functions.cjs
- check:closeflow-tsc-import-regression-rollback-final = node scripts/check-closeflow-tsc-import-regression-rollback-final.cjs
- check:closeflow-tsc-import-regression-final2 = node scripts/check-closeflow-tsc-import-regression-rollback-final.cjs
- check:closeflow-calendar-bundle-import-source = node scripts/check-closeflow-calendar-bundle-import-source.cjs
- check:closeflow-vercel-import-source-final = node scripts/check-closeflow-vercel-import-source-final.cjs
- check:closeflow-api-runtime-finance-import-extensions = node scripts/check-closeflow-api-runtime-finance-import-extensions.cjs
- check:closeflow-api-runtime-data-contract-server-safe = node scripts/check-closeflow-api-runtime-data-contract-server-safe.cjs
- check:closeflow-fin6-payments-list-types = node scripts/check-closeflow-fin6-payments-list-types.cjs
- check:closeflow-fin7-client-finance-summary = node scripts/check-closeflow-fin7-client-finance-summary.cjs
- check:closeflow-fin8-finance-visual-integration = node scripts/check-closeflow-fin8-finance-visual-integration.cjs
- check:closeflow-fin8-surfacecard-dedup-repair3 = node scripts/check-closeflow-fin8-surfacecard-dedup-repair3.cjs
- check:closeflow-fin9-finance-duplicate-safety = node scripts/check-closeflow-fin9-finance-duplicate-safety.cjs
- check:closeflow-finance-contract = node scripts/check-closeflow-finance-contract.cjs
- check:closeflow-finance-ui-contract = node scripts/check-closeflow-finance-ui-contract.cjs
- check:closeflow-finance-payment-types = node scripts/check-closeflow-finance-payment-types.cjs
- check:closeflow-finance-duplicate-safety = node scripts/check-closeflow-finance-duplicate-safety.cjs
- verify:closeflow-finance = node scripts/check-closeflow-finance-contract.cjs && node scripts/check-closeflow-finance-ui-contract.cjs && node scripts/check-closeflow-finance-payment-types.cjs && node scripts/check-closeflow-finance-duplicate-safety.cjs && npm run check:closeflow-case-settlement-panel && npm run check:closeflow-fin6-payments-list-types && npm run check:closeflow-fin7-client-finance-summary && npm run check:closeflow-fin8-finance-visual-integration && npm run check:closeflow-fin9-finance-duplicate-safety && npm run check:closeflow-api0-vercel-hobby-functions && npm run check:closeflow-api-runtime-data-contract-server-safe && npm run check:closeflow-fin5-import-boundaries-final && npx tsc --noEmit --pretty false && npm run build
- check:a2-duplicate-warning-ux-finalizer = node scripts/check-closeflow-a2-duplicate-warning-ux-finalizer.cjs
- check:closeflow-fb1-copy-noise-cleanup = node scripts/check-closeflow-fb1-copy-noise-cleanup.cjs
- check:closeflow-fb2-leads-list-right-rail-cleanup = node scripts/check-closeflow-fb2-leads-list-right-rail-cleanup.cjs
- check:closeflow-fb3-lead-detail-cleanup = node scripts/check-closeflow-fb3-lead-detail-cleanup.cjs
- check:closeflow-fb4-today-behavior-cleanup = node scripts/check-closeflow-fb4-today-behavior-cleanup.cjs
- check:closeflow-fb5-toast-danger-source = node scripts/check-closeflow-fb5-toast-danger-source.cjs
- check:closeflow-fb5-heavy-ui-guards = node scripts/check-closeflow-fb5-heavy-ui-guards.cjs
- check:closeflow-fb5-bulk-ui-contract = node scripts/check-closeflow-fb5-bulk-ui-contract.cjs
- check:closeflow-component-registry = node scripts/check-closeflow-component-registry.cjs
- check:closeflow-entity-icon-registry = node scripts/check-closeflow-entity-icon-registry.cjs
- check:closeflow-finance-model-audit = node scripts/check-closeflow-finance-model-audit.cjs
- check:closeflow-finance-domain-contract = node scripts/check-closeflow-finance-domain-contract.cjs
- check:closeflow-case-roadmap-sot = node scripts/check-closeflow-case-roadmap-source-of-truth.cjs
- check:closeflow-activity-roadmap-labels = node scripts/check-closeflow-activity-roadmap-labels.cjs
- check:closeflow-case-note-actions = node scripts/check-closeflow-case-note-actions.cjs
- check:closeflow-case-detail-no-client-background-panel = node scripts/check-closeflow-case-detail-no-client-background-panel.cjs
- check:closeflow-payments-normalize-datetime-hotfix = node scripts/check-closeflow-payments-normalize-datetime-hotfix.cjs
- check:closeflow-case-quick-actions = node scripts/check-closeflow-case-quick-actions.cjs
- check:closeflow-finance-runtime-esm-imports = node scripts/check-closeflow-finance-runtime-esm-imports.cjs
- check:closeflow-client-primary-case = node scripts/check-closeflow-client-primary-case.cjs
- check:closeflow-stage-polish-guard = node scripts/check-closeflow-stage-polish-guard.cjs
- check:closeflow-client-finance-summary = node scripts/check-closeflow-client-finance-summary.cjs
- check:closeflow-client-card-next-action-layout = node scripts/check-closeflow-client-card-next-action-layout.cjs
- check:closeflow-lead-detail-polish-copy = node scripts/check-closeflow-lead-detail-polish-copy.cjs
- check:closeflow-client-archive-calendar-cascade = node scripts/check-closeflow-client-archive-calendar-cascade.cjs
- check:closeflow-case-client-roadmap-repair = node scripts/check-closeflow-case-client-roadmap-repair.cjs
- check:closeflow-client-case-delete-confirm = node scripts/check-closeflow-client-case-delete-confirm.cjs
- verify:closeflow:quiet:wide = node scripts/closeflow-release-check-quiet-wide.cjs
- check:case-detail-no-partial-loading = node scripts/check-closeflow-case-detail-no-partial-loading.cjs
- check:case-trash-actions = node scripts/check-closeflow-case-trash-actions.cjs
- check:today-mobile-tile-focus = node scripts/check-closeflow-today-mobile-tile-focus.cjs
- check:closeflow-cases-loader2-import = node scripts/check-closeflow-cases-loader2-import.cjs
- check:etap3-clients-wide-layout = node scripts/check-closeflow-etap3-clients-wide-layout.cjs
- check:modal-visual-system = node scripts/check-closeflow-modal-visual-system.cjs
- check:modal-visual-system-readable-v2 = node scripts/check-closeflow-modal-visual-system-readable-v2.cjs
- check:etap4-client-next-action-accent = node scripts/check-closeflow-etap4-client-next-action-accent.cjs
- check:etap5-cases-delete-from-list = node scripts/check-closeflow-etap5-cases-delete-from-list.cjs
- check:etap6-cases-clean-list-title-completeness = node scripts/check-closeflow-etap6-cases-clean-list-title-completeness.cjs
- check:closeflow-admin-feedback-2026-05-11 = node scripts/check-closeflow-admin-feedback-2026-05-11.cjs
- check:etap8-client-card-inline-row = node scripts/check-closeflow-etap8-client-card-inline-row.cjs
- check:stage39-page-headers-copy-visual-system = node scripts/check-stage39-page-headers-copy-visual-system.cjs
- check:stage40-page-header-action-overflow-hardening = node scripts/check-stage40-page-header-action-overflow-hardening.cjs
- check:case-detail-quick-actions-cleanup = node scripts/check-closeflow-case-detail-quick-actions-cleanup.cjs
- check:billing-cleanup-2026-05-11 = node scripts/check-closeflow-billing-cleanup-2026-05-11.cjs
- check:support-visible-ticket-list = node scripts/check-closeflow-support-visible-ticket-list.cjs
- check:closeflow-admin-feedback-2026-05-11-p2 = node scripts/check-closeflow-admin-feedback-2026-05-11-p2.cjs
- check:closeflow-admin-feedback-2026-05-11-p3 = node scripts/check-closeflow-admin-feedback-2026-05-11-p3.cjs
- check:stage14h-calendar-week-nearest7-dedupe = node scripts/check-stage14h-calendar-week-nearest7-dedupe.cjs
- check:stage14i-calendar-snake-case-task-dates = node scripts/check-stage14i-calendar-snake-case-task-dates.cjs
- check:stage14j-calendar-month-entry-ellipsis = node scripts/check-stage14j-calendar-month-entry-ellipsis.cjs
- check:page-header-stage6-final-lock = node scripts/check-closeflow-page-header-stage6-final-lock.cjs
- check:stage14a-clientdetail-notes-history = node scripts/check-closeflow-stage14a-clientdetail-notes-history.cjs
- check:stage14a-clientdetail-notes-history-repair2 = node scripts/check-closeflow-stage14a-clientdetail-notes-history-repair2.cjs
- check:hotfix-asset-cache-stale-chunks = node scripts/check-hotfix-asset-cache-stale-chunks.cjs
- check:closeflow:action-colors:v1 = node scripts/check-closeflow-action-color-taxonomy-v1.cjs
- check:closeflow:action-colors:v1:repair6 = node scripts/check-closeflow-action-color-taxonomy-v1-repair6.cjs
- check:closeflow:calendar-month-v4-freeze = node scripts/check-closeflow-calendar-month-v4-freeze.cjs
- check:mobile-start-tile-trim = node scripts/check-closeflow-mobile-hide-top-tiles-2026-05-12.cjs
- check:mobile-start-tile-trim:repair2 = node scripts/check-closeflow-mobile-hide-top-tiles-repair2-2026-05-12.cjs
- check:closeflow:calendar-selected-day-full-text-repair11 = node scripts/check-closeflow-calendar-selected-day-full-text-repair11.cjs
- check:mobile-visual-source:audit = node tools/audit-closeflow-mobile-visual-source-truth-2026-05-12.cjs
- check:mobile-start-tile-trim:source-truth-final = node scripts/check-closeflow-mobile-hide-top-tiles-source-truth-final-2026-05-12.cjs
- check:closeflow-record-list-source-truth = node scripts/check-closeflow-record-list-source-truth.cjs
- check:closeflow-record-list-dedupe = node scripts/check-closeflow-record-list-dedupe.cjs
- check:closeflow-desktop-density-source-truth = node scripts/check-closeflow-desktop-density-source-truth.cjs
- check:closeflow-compact-top-shell-source-truth = node scripts/check-closeflow-compact-top-shell-source-truth.cjs
- check:closeflow-operator-top-trim-source-truth = node scripts/check-closeflow-operator-top-trim-source-truth.cjs
- check:closeflow-operator-top-trim-repair3 = node scripts/check-closeflow-operator-top-trim-repair3.cjs
- check:closeflow-billing-top-duplicates-removed = node scripts/check-closeflow-billing-top-duplicates-removed.cjs
- check:closeflow-case-detail-history-sort-repair = node scripts/check-closeflow-case-detail-history-sort-repair.cjs
- check:closeflow-case-history-visual-source-truth = node scripts/check-closeflow-case-history-visual-source-truth.cjs
- check:closeflow-clientdetail-hook-order-310-repair = node scripts/check-closeflow-clientdetail-hook-order-310-repair.cjs
- check:closeflow-clientdetail-hook-order-real-refactor = node scripts/check-closeflow-clientdetail-hook-order-real-refactor.cjs
- check:closeflow-clientdetail-hook-order-stabilizer-repair1 = node scripts/check-closeflow-clientdetail-hook-order-stabilizer-repair1.cjs
- check:closeflow-clientdetail-loading-null-safe = node scripts/check-closeflow-clientdetail-loading-null-safe.cjs
- check:closeflow-clientdetail-notes-hook-slot-repair5 = node scripts/check-closeflow-clientdetail-notes-hook-slot-repair5.cjs
- check:case-finance-ghosts = node scripts/check-case-finance-ghosts-2026-05-12.cjs
- diagnose:finance-ghosts = node scripts/diagnose-finance-ghosts-2026-05-12.cjs
- check:case-settlement-edit-values = node scripts/check-case-settlement-edit-values-2026-05-12.cjs
- diagnose:case-settlement-edit-values = node scripts/diagnose-case-settlement-edit-values-2026-05-12.cjs
- check:fin10 = node scripts/check-fin10-case-finance-source-truth.cjs
- test:fin10 = node --test tests/case-finance-source.test.cjs
- verify:fin10 = npm.cmd run check:fin10 && npm.cmd run test:fin10
- check:fin11 = node scripts/check-fin11-case-right-finance-panel.cjs
- test:fin11 = node --test tests/fin11-case-right-finance-panel.test.cjs
- verify:fin11 = npm.cmd run check:fin11 && npm.cmd run test:fin11 && npm.cmd run check:fin10 && npm.cmd run test:fin10
- check:fin13 = node scripts/check-fin13-client-case-finances.cjs
- test:fin13 = node --test tests/fin13-client-case-finances.test.cjs
- verify:fin13 = npm.cmd run check:fin13 && npm.cmd run test:fin13
- check:fin14 = node scripts/check-fin14-payment-types.cjs
- test:fin14 = node --test tests/fin14-payment-types.test.cjs
- verify:fin14 = npm.cmd run check:fin14 && npm.cmd run test:fin14
- check:fin15 = node scripts/check-fin15-lead-finance-ghosts.cjs
- test:fin15 = node --test tests/fin15-lead-finance-ghosts.test.cjs
- verify:fin15 = npm run check:fin15 && npm run test:fin15 && node --test tests/lead-service-mode-v1.test.cjs
- check:lead-detail-feedback-p1 = node scripts/check-lead-detail-feedback-p1-2026-05-13.cjs
- test:lead-detail-feedback-p1 = node --test tests/lead-detail-feedback-p1-2026-05-13.test.cjs
- check:p1a-no-global-focus-refresh = node scripts/check-p1a-no-global-focus-refresh-2026-05-13.cjs
- test:p1a-no-global-focus-refresh = node --test tests/p1a-no-global-focus-refresh-2026-05-13.test.cjs
- check:calendar:selected-day-agenda-v2 = node scripts/check-calendar-selected-day-agenda-v2.cjs
- check:calendar:safe-entry-dates-runtime-v3 = node scripts/check-calendar-safe-entry-dates-runtime-v3.cjs
- check:calendar:selected-day-new-tile-v9 = node scripts/check-calendar-selected-day-new-tile-v9-massfix.cjs
- check:calendar:selected-day-new-tile-v9-massfix = node scripts/check-calendar-selected-day-new-tile-v9-massfix.cjs
- check:calendar-selected-day-handler-scope = node scripts/check-calendar-selected-day-handler-scope.cjs
...
- check:right-rail-source-truth = node scripts/check-right-rail-source-truth.cjs
- check:clients-leads-only-attention-stage71 = node scripts/check-clients-leads-only-attention-stage71.cjs
- check:clients-attention-rail-visual-stage72 = node scripts/check-clients-attention-rail-visual-stage72.cjs
- check:closeflow-repo-hygiene-stage73 = node scripts/check-closeflow-repo-hygiene-stage73.cjs
- check:json-no-bom-stage73b = node scripts/check-json-no-bom-stage73b.cjs
- audit:right-rail-cards = node tools/audit-right-rail-card-styles.cjs
- check:right-rail-cards = node tools/audit-right-rail-card-styles.cjs --check
- check:stage74-clients-leads-to-link-panel = node scripts/check-stage74-clients-leads-to-link-panel.cjs
- test:stage74-clients-leads-to-link-panel = node --test tests/stage74-clients-leads-to-link-panel.test.cjs
- check:right-rail-card-source-of-truth = node scripts/check-right-rail-card-source-of-truth-stage75.cjs
- test:right-rail-card-source-of-truth = node --test tests/right-rail-card-source-of-truth.test.cjs
- check:stage76-today-event-done-action = node scripts/check-stage76-today-event-done-action.cjs
- test:stage76-today-event-done-action = node --test tests/stage76-today-event-done-action.test.cjs
- check:stage77-lead-detail-single-status-pill = node scripts/check-stage77-lead-detail-single-status-pill.cjs
- test:stage77-lead-detail-single-status-pill = node --test tests/stage77-lead-detail-single-status-pill.test.cjs
- check:stage78-lead-detail-no-static-ai-followup-card = node scripts/check-stage78-lead-detail-no-static-ai-followup-card.cjs
- test:stage78-lead-detail-no-static-ai-followup-card = node --test tests/stage78-lead-detail-no-static-ai-followup-card.test.cjs
- check:stage79-today-task-done-action = node scripts/check-stage79-today-task-done-action.cjs
- test:stage79-today-task-done-action = node --test tests/stage79-today-task-done-action.test.cjs
- check:stage79-release-gate-mass-guard = node scripts/check-stage79-release-gate-mass-guard.cjs
- test:stage79-release-gate-mass-guard = node --test tests/stage79-release-gate-mass-guard.test.cjs
- check:stage80-today-task-done-desktop-visibility = node scripts/check-stage80-today-task-done-desktop-visibility.cjs
- test:stage80-today-task-done-desktop-visibility = node --test tests/stage80-today-task-done-desktop-visibility.test.cjs
- check:todaystable:no-free-task = node tools/check-todaystable-no-free-task.cjs
- check:todaystable-next7-v30 = node tools/check-todaystable-next7-v30.cjs
- check:operator-rail-stage5-guard-compat = node scripts/check-operator-rail-stage5-guard-compat.cjs
- check:project-memory = node scripts/check-project-memory.cjs
- check:stage83-right-rail-stale-cleanup = node --test tests/stage83-right-rail-stale-cleanup.test.cjs
- test:stage83-right-rail-stale-cleanup = node --test tests/stage83-right-rail-stale-cleanup.test.cjs
- check:stage84-import-doctor-right-rail = node --test tests/stage84-import-doctor-right-rail.test.cjs

### scripts sample
- scripts\apply-a29b-supabase-runtime-shell-today.cjs
- scripts\apply-a29e-today-supabase-user-runtime.cjs
- scripts\apply-stage32-ai-assistant-query-brain.cjs
- scripts\apply-stage33-ai-semantic-router-v2-and-aidrafts-fix.cjs
- scripts\apply-stage34-calendar-readability-status-forms.cjs
- scripts\apply-stage34b-calendar-complete-polish.cjs
- scripts\apply-stage70-82-patches.cjs
- scripts\apply-stage70-82-repair.cjs
- scripts\apply-stage83-task-next-step-prompt.cjs
- scripts\audit-client-case-legacy-layers.cjs
- scripts\audit-closeflow-action-clusters-final-contract.cjs
- scripts\audit-closeflow-active-screen-layout-matrix.cjs
- scripts\audit-closeflow-metric-tiles-deep-source-map.cjs
- scripts\audit-closeflow-metric-tiles-final-migration.cjs
- scripts\audit-closeflow-style-map.cjs
- scripts\audit-closeflow-ui-map-inventory-v1.cjs
- scripts\audit-closeflow-ui-map.cjs
- scripts\audit-closeflow-ui-surface-stage45.mjs
- scripts\audit-closeflow-visual-system-inventory.cjs
...
- scripts\build-closeflow-ui-semantic-contract-v1.cjs
- scripts\build-closeflow-ui-semantic-icon-baseline-v1.cjs
- scripts\check-a13-critical-regressions.cjs
- scripts\check-a14-business-types.cjs
- scripts\check-a15-email-verification.cjs
- scripts\check-a16-no-onchange-write-storm.cjs
- scripts\check-a18-branding-docs.cjs
- scripts\check-a19-admin-role.cjs
- scripts\check-a19v2-admin-schema-sidebar.cjs
- scripts\check-a20-runtime-imports.cjs
- scripts\check-a20-status-contract-sidebar.cjs
- scripts\check-a20c-sidebar-hitbox.cjs
- scripts\check-a20d-sidebar-pointer-router.cjs
- scripts\check-a20e-sidebar-today-tone.cjs
...
- scripts\check-a25-nearest-planned-action.cjs
- scripts\check-a25e-lead-health-null-guard.cjs
- scripts\check-a26-activities-ai-drafts-supabase.cjs
- scripts\check-a27b-response-templates-supabase.cjs
- scripts\check-a27c-response-templates-sql-fix.cjs
- scripts\check-a27g-response-template-encoding.cjs
- scripts\check-a28-digest-notifications-pwa.cjs
- scripts\check-a29-supabase-runtime-shell.cjs
- scripts\check-a29f-vercel-deploy-hotfix.cjs
- scripts\check-access-billing-source-of-truth-stage02a.cjs
- scripts\check-admin-ai-role-gate.cjs
- scripts\check-admin-backend-guard.cjs
- scripts\check-admin-button-matrix.cjs
- scripts\check-admin-click-to-annotate.cjs
- scripts\check-admin-debug-toolbar.cjs
- scripts\check-admin-dialog-drag-lower.cjs
- scripts\check-admin-dialog-stack-fix.cjs
- scripts\check-admin-feedback-export.cjs
- scripts\check-admin-feedback-p1-followup.cjs
- scripts\check-admin-feedback-p1-hotfix.cjs
- scripts\check-admin-quick-editor-portal-drag.cjs
- scripts\check-admin-review-mode.cjs
- scripts\check-admin-toolbar-utf8-portal-force.cjs
- scripts\check-ai-app-context-operator-stage26.cjs
- scripts\check-ai-drafts-route-runtime-repair.cjs
- scripts\check-assistant-operator-v1.cjs
- scripts\check-billing-truth.cjs
...
- scripts\check-calendar-selected-day-handler-scope.cjs
- scripts\check-calendar-selected-day-handlers-runtime-fix-v10-finalize.cjs
- scripts\check-calendar-selected-day-new-tile-v9-massfix.cjs
- scripts\check-case-detail-history-visual-p1-repair3-2026-05-13.cjs
- scripts\check-case-detail-history-visual-p1-repair4-2026-05-13.cjs
- scripts\check-case-detail-history-visual-p1-repair5-2026-05-13.cjs
- scripts\check-case-detail-history-workrow-leak-fix-2026-05-13.cjs
- scripts\check-case-detail-no-activity-notes-final-2026-05-13.cjs
- scripts\check-case-detail-no-activity-notes-workitems-2026-05-13.cjs
- scripts\check-case-detail-rewrite-build-workitems-final-2026-05-13.cjs
- scripts\check-case-finance-ghosts-2026-05-12.cjs
- scripts\check-case-settlement-edit-values-2026-05-12.cjs
- scripts\check-client-detail-id-route-hotfix.cjs
- scripts\check-client-detail-next-action-tile-polish-2026-05-12.cjs
...
- scripts\check-closeflow-a1-client-note-event-lead-visibility-finalizer.cjs
- scripts\check-closeflow-a2-duplicate-warning-ux-finalizer.cjs
- scripts\check-closeflow-a2-duplicate-warning-ux-full.cjs
- scripts\check-closeflow-action-clusters-final-contract.cjs
- scripts\check-closeflow-action-color-taxonomy-v1-repair6.cjs
- scripts\check-closeflow-action-color-taxonomy-v1.cjs
- scripts\check-closeflow-action-icon-registry.cjs
- scripts\check-closeflow-active-legacy-color-contract.cjs
- scripts\check-closeflow-active-screen-layout-matrix.cjs
- scripts\check-closeflow-activity-roadmap-labels.cjs
- scripts\check-closeflow-admin-feedback-2026-05-11-p2.cjs
- scripts\check-closeflow-admin-feedback-2026-05-11-p3.cjs
- scripts\check-closeflow-admin-feedback-2026-05-11.cjs
- scripts\check-closeflow-admin-feedback-visual-repair.cjs
- scripts\check-closeflow-alert-severity-contract.cjs
- scripts\check-closeflow-api-runtime-data-contract-server-safe.cjs
- scripts\check-closeflow-api-runtime-finance-import-extensions.cjs
- scripts\check-closeflow-api0-vercel-hobby-functions.cjs
- scripts\check-closeflow-billing-cleanup-2026-05-11.cjs
- scripts\check-closeflow-billing-top-duplicates-removed.cjs
- scripts\check-closeflow-build-blockers-masscheck-leaddetail-fix.cjs
- scripts\check-closeflow-calendar-activity-severity-contract.cjs
- scripts\check-closeflow-calendar-bundle-import-source.cjs
- scripts\check-closeflow-calendar-color-tooltip-v2.cjs
- scripts\check-closeflow-calendar-month-chip-overlap-fix-v1.cjs
- scripts\check-closeflow-calendar-month-entry-structural-fix-v3-repair2.cjs
- scripts\check-closeflow-calendar-month-light-selected-day-real-entries-repair2.cjs
- scripts\check-closeflow-calendar-month-overlap-deep-audit.cjs
- scripts\check-closeflow-calendar-month-plain-text-deep-audit.cjs

### tests sample
- tests\a13-critical-regressions.test.cjs
- tests\activity-command-center.test.cjs
- tests\activity-right-rail-hotfix.test.cjs
- tests\activity-visual-rebuild.test.cjs
- tests\admin-backend-guard.test.cjs
- tests\admin-click-to-annotate.test.cjs
- tests\admin-dialog-drag-lower.test.cjs
- tests\admin-dialog-stack-fix.test.cjs
- tests\admin-quick-editor-portal-drag.test.cjs
- tests\admin-review-mode-compat.test.cjs
- tests\admin-toolbar-utf8-portal-force.test.cjs
- tests\admin-tools.test.cjs
...
- tests\app-chunk-error-boundary.test.cjs
- tests\assistant-no-autowrite.test.cjs
- tests\assistant-operator-context.test.cjs
...
- tests\billing-checkout.test.cjs
- tests\billing-copy-cleanup-stage15.test.cjs
- tests\billing-dry-run-test-order-regression.test.cjs
- tests\billing-error-label-fix-stage22.test.cjs
- tests\billing-foundation-test-polish-label-regression.test.cjs
- tests\billing-label-compat-stage21.test.cjs
...
- tests\billing-visual-rebuild.test.cjs
- tests\billing-webhook.test.cjs
...
- tests\case-detail-delete-placement-stage7b.test.cjs
- tests\case-detail-delete-placement.test.cjs
...
- tests\case-finance-commission-semantics.test.cjs
...
- tests\clientdetail-p1-functional-contract.test.cjs
- tests\clientdetail-tabs-order.test.cjs
- tests\closeflow-release-gate-quiet.test.cjs
- tests\closeflow-release-gate.test.cjs
- tests\cumulative-next-stages-stage07.test.cjs
- tests\cumulative-resume-stage08.test.cjs
...
- tests\data-contract-normalization.test.cjs
- tests\digest-email.test.cjs
- tests\draft-confirmation-flow.test.cjs
...
## Tests / guards
- OK - node scripts/check-project-memory.cjs (exit 0)
- OK - npm run check:project-memory (exit 0)
- SKIP - script not found - npm run typecheck (exit -1)
- FAIL - npm run build (exit 1)
- FAIL - npm run verify:closeflow:quiet (exit 1)
...
JSON_NO_BOM_STAGE73B_FAIL: package.json starts with UTF-8 BOM
...
CLOSEFLOW_CASES_IMPORT_CONTRACT_OK
OK case detail no partial loading
OK case detail no partial loading
OK case detail loading reference
OK today header actions stack
OK today mobile tile focus
OK case trash actions


FAILED: production build
[36mvite v6.4.2 [32mbuilding for production...[36m[39m
transforming...
[32mâś“[39m 3 modules transformed.

[31mâś—[39m Build failed in 89ms
[31m[@tailwindcss/vite:generate:build] C:\Users\malim\Desktop\biznesy_ai\2.closeflow\package.json (directory description file): SyntaxError: C:\Users\malim\Desktop\biznesy_ai\2.closeflow\package.json (directory description file): SyntaxError: C:\Users\malim\Desktop\biznesy_ai\2.closeflow\package.json (directory description file): SyntaxError: C:\Users\malim\Desktop\biznesy_ai\2.closeflow\package.json (directory description file): SyntaxError: C:\Users\malim\Desktop\biznesy_ai\2.closeflow\package.json (directory description file): SyntaxError: C:\Users\malim\Desktop\biznesy_ai\2.closeflow\package.json (directory description file): SyntaxError: C:\Users\malim\Desktop\biznesy_ai\2.closeflow\package.json (directory description file): SyntaxError: C:\Users\malim\Desktop\biznesy_ai\2.closeflow\package.json (directory description file): SyntaxError: Unexpected token 'ď»ż', "ď»ż{
    "n"... is not valid JSON[39m
file: [36mC:/Users/malim/Desktop/biznesy_ai/2.closeflow/src/index.css[39m
    at JSON.parse (<anonymous>)
    at Object.<anonymous> (C:\Users\malim\Desktop\biznesy_ai\2.closeflow\node_modules\enhanced-resolve\lib\CachedInputFileSystem.js:625:26)
    at CacheBackend.provideSync (C:\Users\malim\Desktop\biznesy_ai\2.closeflow\node_modules\enhanced-resolve\lib\CachedInputFileSystem.js:344:67)
    at SyncAsyncFileSystemDecorator.readJson (C:\Users\malim\Desktop\biznesy_ai\2.closeflow\node_modules\enhanced-resolve\lib\SyncAsyncFileSystemDecorator.js:197:29)
    at C:\Users\malim\Desktop\biznesy_ai\2.closeflow\node_modules\enhanced-resolve\lib\DescriptionFileUtils.js:104:26
    at next (C:\Users\malim\Desktop\biznesy_ai\2.closeflow\node_modules\enhanced-resolve\lib\forEachBail.js:35:3)
    at forEachBail (C:\Users\malim\Desktop\biznesy_ai\2.closeflow\node_modules\enhanced-resolve\lib\forEachBail.js:49:9)
    at findDescriptionFile (C:\Users\malim\Desktop\biznesy_ai\2.closeflow\node_modules\enhanced-resolve\lib\DescriptionFileUtils.js:70:3)
  ...
  hook: 'transform',
  id: 'C:/Users/malim/Desktop/biznesy_ai/2.closeflow/src/index.css',
  watchFiles: [
    'C:/Users/malim/Desktop/biznesy_ai/2.closeflow/index.html',
    'C:/Users/malim/Desktop/biznesy_ai/2.closeflow/src/main.tsx',
    'C:\\Users\\malim\\Desktop\\biznesy_ai\\2.closeflow\\package.json',
    'C:/Users/malim/Desktop/biznesy_ai/2.closeflow/src/App.tsx',
    'C:/Users/malim/Desktop/biznesy_ai/2.closeflow/node_modules/react/jsx-runtime.js',
    'C:/Users/malim/Desktop/biznesy_ai/2.closeflow/node_modules/react-dom/client.js',
    'C:/Users/malim/Desktop/biznesy_ai/2.closeflow/src/index.css'
  ]
}


## DECYZJA
- Project memory files are first place to read before future work.

## HIPOTEZA / PROPOZYCJA
- Review old Obsidian notes moved to backup.

## DO POTWIERDZENIA
- Damian should confirm backup report and guard results.