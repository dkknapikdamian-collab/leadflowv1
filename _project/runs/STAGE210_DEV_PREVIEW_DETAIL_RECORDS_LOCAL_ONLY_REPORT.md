# STAGE210_DEV_PREVIEW_DETAIL_RECORDS_LOCAL_ONLY_REPORT
...
- Damian chce obejrzeć widoki szczegółów klienta, leada i sprawy bez podpinania Supabase.
- Nie chcemy dodawać prawdziwych testowych danych do bazy.
- Repo już ma dev-preview fixtures: dev-client-1, dev-client-2, dev-client-3, dev-lead-1, dev-lead-2, dev-lead-3, dev-case-1, dev-case-2.
- Listy korzystały z dev-preview.
- Widoki detail by ID nie korzystały z dev-preview i szły do API.
- Stage210 podpina istniejące dev-preview rows do:
  - fetchClientByIdFromSupabase
  - fetchLeadByIdFromSupabase
  - fetchCaseByIdFromSupabase
- Stage210 nie dodaje nowych danych testowych.
- Stage210 nie dotyka Supabase.
- Stage210 nie wykonuje git add, commita ani pusha.
...
- Obejrzeć widoki szczegółów i poprawić UI lokalnie.
- Nie commitować fixture danych.
- Jeśli Stage210 zostanie później zaakceptowany, można go zostawić jako dev-only preview support, bo nie uruchamia się przy skonfigurowanym Supabase.
