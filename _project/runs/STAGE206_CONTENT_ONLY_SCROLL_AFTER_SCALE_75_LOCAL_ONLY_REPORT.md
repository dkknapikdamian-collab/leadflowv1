# STAGE206_CONTENT_ONLY_SCROLL_AFTER_SCALE_75_LOCAL_ONLY_REPORT
...
- Stage203 scrollował body/html.
- Stage205 zablokował body, ale nie oddał scrolla właściwemu środkowi.
- Layout ma global-bar i div.view.active[data-shell-content=true] wewnątrz main.
- Stage206 robi scroll-ownerem tylko div.view.active[data-shell-content=true].
- Sidebar i global-bar zostają nieruchome.
- Skala 75% zostaje.
...
- npm run build
- npm run dev
- ręcznie: /calendar, /activity, /notifications, /ai-drafts, /tasks
...
- Sprawdzić, czy scrolluje tylko środkowy panel treści pod global-barem.
