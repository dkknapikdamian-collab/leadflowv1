# STAGE200B_REPAIR_MALFORMED_CSS_IMPORT_COMMENT_LOCAL_ONLY_REPORT
...
- Stage200 wyłączył stare importy visual/density/sidebar w kilku plikach.
- Guard Stage200 przeszedł.
- Build padł na src/index.css.
- Błąd: Invalid declaration: */ @import '../stageA19v2-sidebar-nav-contrast-fix.css'
- Przyczyna: malformed CSS comment/import po automatycznym komentowaniu linii.
...
- scan CSS for malformed */ @import
- node scripts/check-stage200-no-legacy-visual-scale.cjs
- npm run build
- potem npm run dev i Ctrl+F5
...
- Sprawdzić / i /tasks.
- Oczekiwane: brak proporcji 0.8, sidebar nie powinien mieć 192 x 729.59375 przy viewport 1920 x 912.
