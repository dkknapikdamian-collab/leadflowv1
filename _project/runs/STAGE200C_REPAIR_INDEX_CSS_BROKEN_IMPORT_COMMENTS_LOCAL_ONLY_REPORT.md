# STAGE200C_REPAIR_INDEX_CSS_BROKEN_IMPORT_COMMENTS_LOCAL_ONLY_REPORT
...
- Stage200B nie wystarczył.
- Build dalej padał w src/index.css.
- Nowy błąd: malformed comment/import przy CLOSEFLOW_PAGE_HEADER_FINAL_LOCK_PACKET2_ENTRY.
- Stage200C normalizuje wszystkie linie index.css, gdzie komentarz i @import skleiły się w jedną niepoprawną deklarację.
- Zakazane legacy importy Stage200 pozostają wyłączone.

## NAPRAWIONE LINIE

- brak naprawionych linii

## TESTY

- kontrola linii @import w src/index.css
- kontrola typowych śmieci: */ @import, */@import, * CLOSEFLOW_PAGE_HEADER...
...
- Sprawdzić / i /tasks.
- Jeżeli sidebar dalej będzie 0.8, wykonać runtime matched CSS rules.
