# STAGE200G_HOIST_LATE_EMERGENCY_IMPORTS_LOCAL_ONLY_REPORT
...
- Build dalej padał po Stage200F.
- Błąd wskazywał na późne @import po normalnych deklaracjach CSS.
- src/index.css importuje hub emergency-hotfixes.css.
- emergency-hotfixes.css zawierał zwykłe reguły CSS, a potem późne @import page/header/metric locków.
- Tailwind wymaga, żeby aktywne @import były przed normalnymi deklaracjami.
- Stage200G przenosi późne importy z emergency-hotfixes.css do src/index.css zaraz po imporcie emergency huba.
- Zakazane legacy 80% zoom/density/sidebar importy pozostają wyłączone.
- Nie wykonano git add, commita ani pusha.

## WYNIK SKRYPTU

{   "hoistedFromEmergency": [     "./styles/closeflow-page-header-copy-source-truth.css",     "./styles/closeflow-page-header-action-semantics-packet1.css",     "./styles/closeflow-page-header-stage6-final-lock.css"   ],   "bad": [] }

## TESTY

- node scripts/repair-stage200g-hoist-late-emergency-imports.cjs
