# STAGE200E_HARD_REPAIR_INDEX_CSS_IMPORT_LINES_LOCAL_ONLY_REPORT
...
- Stage200D nadal nie doprowadził builda do zielonego.
- Build padał na src/index.css.
- Błąd: komentarz i @import nadal były sklejone w jedną niepoprawną deklarację.
- Stage200E naprawia wyłącznie linie @import w src/index.css.
- Zakazane legacy importy 80% zoom/density/sidebar pozostają wyłączone.

## WYNIK SKRYPTU

{   "file": "src/index.css",   "fixes": [],   "bad": [] }

## TESTY

- node scripts/repair-stage200e-index-css-import-lines.cjs
