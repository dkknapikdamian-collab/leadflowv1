# STAGE200I_RESET_CSS_HUBS_DISABLE_ONLY_FIT_CONTENT_IMPORT_LOCAL_ONLY_REPORT
...
- Stage200B-H narobiły uszkodzeń komentarzy przy @import w hubach CSS.
- Build nadal padał na komentarz + @import.
- Czyste huby CSS w repo mają poprawne komentarze i importy.
- Stage200I resetuje wszystkie huby CSS z HEAD.
- Stage200I wykonuje tylko jedną zamierzoną zmianę: wyłącza eliteflow-sidebar-user-footer-below-nav.css.
...
- kontrola uszkodzonych komentarzy/importów w hubach
