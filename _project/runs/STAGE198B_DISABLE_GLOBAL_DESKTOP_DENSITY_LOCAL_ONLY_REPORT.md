# STAGE198B_DISABLE_GLOBAL_DESKTOP_DENSITY_LOCAL_ONLY_REPORT

FAKTY:
- Debug pokazał proporcję 0.8: viewport height 912, sidebar height 729.59375.
- 912 * 0.8 = 729.6.
- 240 * 0.8 = 192.
- Problem wygląda jak globalne zmniejszenie shellu/layoutu, nie jak sam błąd sidebara.
- Stage198B wyłącza import closeflow-desktop-density-source-truth.css.
- Plik CSS nie został usunięty, tylko import został zakomentowany.
- Nie wykonano git add, commita ani pusha.

DECYZJA DAMIANA:
- Widok nie ma wyglądać jak zmniejszony.
- Nie robimy kolejnych sidebar-only patchy.
...
- Sprawdzić, czy panel boczny i main wróciły do normalnej skali.
- Sprawdzić, czy sidebar dochodzi do dołu viewportu.
