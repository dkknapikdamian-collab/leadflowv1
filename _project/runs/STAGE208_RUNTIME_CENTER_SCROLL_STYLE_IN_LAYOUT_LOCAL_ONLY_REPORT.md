# STAGE208_RUNTIME_CENTER_SCROLL_STYLE_IN_LAYOUT_LOCAL_ONLY_REPORT
...
- Runtime JSON pokazał, że content ma canScroll=true, ale overflowY=visible.
- To znaczy, że właściwy element istnieje i ma nadmiar treści, ale nie jest właścicielem scrolla.
- Stage207 jako zwykły CSS nie wygrał albo nie dotarł.
- Stage208 usuwa importy Stage202/203/205/206/207.
- Stage208 dodaje runtime style tag bezpośrednio w Layout.tsx, po OperatorTopBarRuntime.
- Scroll-ownerem ma być main[data-shell-main=true] > div.view.active[data-shell-content=true].
- Body/root/app/main nie mają scrollować strony.
- Skala 75% zostaje.
...
- npm run build
- npm run dev
- DevTools runtime table:
  - body.canScroll=false
  - root can be false/hidden
...
- Jeżeli content dalej ma overflowY=visible, to runtime style tag nie został zbudowany albo został usunięty.
