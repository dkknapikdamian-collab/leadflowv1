# STAGE200_REMOVE_LEGACY_80_ZOOM_AND_SIDEBAR_FIT_CONTENT_LOCAL_ONLY_REPORT
...
- Admin debug pokazał viewport 1920 x 912.
- Admin debug pokazał aside.sidebar 192 x 729.59375.
- 240 * 0.8 = 192.
- 912 * 0.8 = 729.6.
- To wskazuje na aktywne globalne skalowanie / density 80%, nie tylko na błąd height sidebara.
- W repo była podejrzana stara warstwa: closeflow-viewport-zoom-80-source-truth-stage157.css.
- Stare warstwy sidebara i fit-content mogły wygrywać z Layout.tsx.

## DECYZJA DAMIANA

- Szukać głęboko starych powiązań i błędów renderowania.
- Nie pchać do repo.
- Nie dokładać kolejnych kosmetycznych CSS-plastrów.
- Usunąć aktywne stare warstwy, które zmniejszają albo ścinają panel.

## ZMIENIONE PLIKI

- src\components\Layout.tsx
- src\styles\temporary\temporary-overrides.css
- src\App.tsx

## WYŁĄCZONE LINIE

- src\components\Layout.tsx :: /* STAGE198B disabled global 80pct density import: closeflow-desktop-density-source-truth.css */
- src\styles\temporary\temporary-overrides.css :: /* STAGE197B disabled old fit-content sidebar import: @import '../eliteflow-sidebar-user-footer-below-nav.css'; */
- src\App.tsx :: import './styles/closeflow-viewport-zoom-80-source-truth-stage157.css';
...
- npm run build
- npm run dev
- ręcznie: /, /tasks, /leads, /settings, Ctrl+F5
...
- Po buildzie uruchomić npm run dev.
- Sprawdzić, czy sidebar nie ma już proporcji 0.8.
- Oczekiwane: sidebar nie powinien mieć 192 x 729.59375 przy viewport 1920 x 912.
- Jeżeli dalej będzie 0.8, kolejny ruch to runtime matched CSS rules, ale już bez zgadywania.
