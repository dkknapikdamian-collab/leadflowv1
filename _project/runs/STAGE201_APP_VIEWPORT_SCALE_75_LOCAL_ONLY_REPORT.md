# STAGE201_APP_VIEWPORT_SCALE_75_LOCAL_ONLY_REPORT
...
- Stage200I przywrócił działanie po usunięciu starej warstwy 80%.
- UI na 100% jest dla Damiana za duży.
- Damian wskazał, że browser zoom 75% wygląda właściwie.
- Stage201 nie przywraca starego legacy 80% zoom/density.
- Stage201 dodaje kontrolowaną skalę 75% na desktopie.
- Stage201 kompensuje viewport przez width/height 133.333%, żeby sidebar nie kończył się przed dołem ekranu.
...
- Sprawdzić, czy aplikacja wygląda jak 75% zoom.
- Sprawdzić, czy sidebar dochodzi do dołu.
- Sprawdzić, czy scroll działa na /tasks i /leads.
