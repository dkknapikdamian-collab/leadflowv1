...
## G7-R2-R3 - executable mojibake guard and package diff truth closeout

DATA_I_CZAS: 2026-07-11 15:17 Europe/Warsaw
REPAIR_STAGE: LF-PROD-SOT-G7-R2-R3_MOJIBAKE_GUARD_AND_PACKAGE_DIFF_TRUTH_CLOSEOUT
MOJIBAKE_EXECUTABLE_GUARD: PASS
FORBIDDEN_MOJIBAKE_TOKENS: BROKEN_EM_DASH / BROKEN_EN_DASH / A_TILDE / A_CIRCUMFLEX
PACKAGE_JSON_ACCEPTANCE_METHOD: SEMANTIC_PARSED_JSON_COMPARISON
PACKAGE_JSON_RAW_TEXT_DIFF_USED_AS_ACCEPTANCE: NO
G7_BEHAVIORAL_TEST_COUNT: 26
G7_VERIFY_RERUN: PASS
BUILD_RERUN: PASS
RUNTIME_BEHAVIOR_CHANGED: NO
PACKAGE_JSON_CHANGED: NO
TSCONFIG_G7_CHANGED: NO
SRC_CHANGED: NO
G8_CREATED: NO
G7_R2_R3_FINAL_STATUS: PASS_G7_EXECUTABLE_MOJIBAKE_GUARD_AND_PACKAGE_DIFF_TRUTH
