# STAGE204_OPS_BADGES_AND_ICONS_STRETCH_LOCAL_ONLY_REPORT
...
- Damian wskazał zakładki: Powiadomienia, Inbox szkiców, Aktywność.
- Problem dotyczy małych ikonek/liczników, które wyglądają zbyt drobno i punktowo.
- Stage204 nie zmienia logiki danych.
- Stage204 nie zmienia skali aplikacji.
- Stage204 nie zmienia sidebara.
- Stage204 dodaje tylko CSS dla filtrów, liczników i ikon wierszy na tych trzech stronach.
...
- npm run build
- npm run dev
- ręcznie: /notifications, /ai-drafts, /activity
...
- Sprawdzić, czy liczniki w filtrach są poziomymi kapsułami.
- Sprawdzić, czy ikonki w wierszach są szersze i czytelniejsze.
- Jeżeli nadal są za małe, zwiększyć width 40px -> 44px oraz height 30px -> 32px.
