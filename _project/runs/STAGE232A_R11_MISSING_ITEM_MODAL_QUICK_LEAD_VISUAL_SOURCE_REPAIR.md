...
- typ: UI visual source truth repair
- repo: dkknapikdamian-collab/leadflowv1
- branch: dev-rollout-freeze

## R11-R1
Pierwsza paczka R11 nie zapisala zmian, bo patcher szukal kotwicy po juz zmienionym const string. R11-R1 uzywa robust regex dla calego const block.

## Zmiana
- Brak modal dziedziczy jasny +Lead / lead-form-vnext.
- Usuniete ciemne background override #0f172a/#111827.
- Guard blokuje powrot ciemnego shellu.

## Manual smoke
1. Otworz modal Brak z LeadDetail.
2. Karta ma byc jasna jak +Lead.
3. Fonty, labelki, pola, checkbox, textarea i footer maja byc spójne.
4. Sprawdz Anuluj i Zapisz brak.
