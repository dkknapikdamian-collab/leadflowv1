# STAGE200F_RESTORE_CSS_HUBS_AND_DISABLE_ONLY_SIDEBAR_FIT_CONTENT_LOCAL_ONLY_REPORT
...
- Stage200B/C/D/E próbowały regexowo naprawiać importy i komentarze.
- Build nadal padał przez sklejony komentarz z @import.
- src/index.css w czystym kontrakcie powinien importować huby CSS, a nie bezpośrednio wszystkie stare stage pliki.
- src/styles/temporary/temporary-overrides.css w czystym kontrakcie zawiera poprawne importy sidebara.
- Stage200F przywrócił src/index.css i temporary-overrides.css z HEAD.
- Stage200F wyłączył tylko eliteflow-sidebar-user-footer-below-nav.css jako podejrzany fit-content sidebar import.
- Stage200F nie robi git add, commita ani pusha.

## TESTY

- walidacja braku */ @import
...
- Jeżeli build przejdzie, sprawdzić runtime.
- Jeżeli sidebar dalej będzie 192 x 729.59375, zrobić runtime matched CSS rules.
