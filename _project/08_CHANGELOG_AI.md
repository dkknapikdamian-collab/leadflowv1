...
## 2026-06-06 15:35 Europe/Warsaw — STAGE227A — Sales Funnel Movement View
...
- Zastąpiono uszkodzony R2 czystym runnerem JS wywoływanym z PowerShell.
...
## 2026-06-10 20:05 Europe/Warsaw — STAGE231D3-R7
...
- Dopasowano Lejek do nowego języka UI CloseFlow.
- Zachowano koncepcję: lista decyzji właściciela, nie kanban.
- Nie zmieniono logiki filtrów, liczenia, Supabase, SQL, statusów, płatności ani routingu.
...
Status: WDROZONE_ZIP_DO_SPRAWDZENIA

Zmiana:
- usunieto odrzucony dopisek spod kafelka/listy `Wymaga ruchu` na ekranie `/today`,
- guard/test zaktualizowano tak, zeby ten dopisek nie wrocil,
- utrzymano techniczny kontrakt STAGE232B.
...
Dodano kontrakt audit-only dla Braki/Blokady lead/case/client.
