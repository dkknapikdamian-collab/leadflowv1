...
KNOWN_REFERENCE_DEVIATIONS: Do not fake drag/reorder or persistence because it appears in the image; omit unsupported controls and document the deviation.
