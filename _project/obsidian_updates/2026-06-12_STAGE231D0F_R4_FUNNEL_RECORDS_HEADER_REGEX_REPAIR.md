...
- nazwa / alias wejściowy: `STAGE231D0F-R4 — Funnel records header regex repair`
...
- decyzja: stary dwuliniowy nagłówek rekordów Lejka ma być usunięty regexem; zostaje jeden wiersz
- testy: R4 guard/test + R3 guard/test + R2 guard/test jeśli istnieją + build + `git diff --check`
...
- następny krok: apply R4, manual QA `/funnel`, potem selektywny push
