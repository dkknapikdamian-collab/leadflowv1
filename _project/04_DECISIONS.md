...
Decision: keep Stage228B Lead Work Action Center, but fix the production runtime crash by importing AlertTriangle from lucide-react in LeadDetail. Do not revert the full Stage228B unless this hotfix fails.
