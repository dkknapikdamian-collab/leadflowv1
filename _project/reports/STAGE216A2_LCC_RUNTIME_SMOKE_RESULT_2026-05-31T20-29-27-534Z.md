...
- generated_at: 2026-05-31T20:29:27.533Z
...
|---|---:|---|---:|---|
| AUTH_REQUIRED | 401 | /api/leads | 1717ms | Endpoint działa jako JSON, ale wymaga poprawnego auth/workspace context. To nie jest błąd parsowania. |
| FAIL | 500 | /api/clients | 1729ms | AUTHORIZATION_BEARER_REQUIRED |
| AUTH_REQUIRED | 401 | /api/cases | 2837ms | Endpoint działa jako JSON, ale wymaga poprawnego auth/workspace context. To nie jest błąd parsowania. |
