...
- generated_at: 2026-05-31T20:27:00.168Z
...
|---|---:|---|---:|---|
| AUTH_REQUIRED | 401 | /api/leads | 3287ms | Endpoint działa jako JSON, ale wymaga poprawnego auth/workspace context. To nie jest błąd parsowania. |
| FAIL | 500 | /api/clients | 2626ms | AUTHORIZATION_BEARER_REQUIRED |
| AUTH_REQUIRED | 401 | /api/cases | 1668ms | Endpoint działa jako JSON, ale wymaga poprawnego auth/workspace context. To nie jest błąd parsowania. |
