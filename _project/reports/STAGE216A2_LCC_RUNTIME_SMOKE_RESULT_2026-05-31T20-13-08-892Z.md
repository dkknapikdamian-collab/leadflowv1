...
- generated_at: 2026-05-31T20:13:08.891Z
...
|---|---:|---|---:|---|
| FAIL | 200 | /api/leads | 49ms | NON_JSON_RESPONSE:Unexpected token 'i', "import { i"... is not valid JSON |
| FAIL | 200 | /api/clients | 3ms | NON_JSON_RESPONSE:Unexpected token 'i', "import { i"... is not valid JSON |
| FAIL | 200 | /api/cases | 2ms | NON_JSON_RESPONSE:Unexpected token 'i', "import { i"... is not valid JSON |
