...
-
pm run build
- RÄ‚â€žĂ˘â‚¬ĹˇÄ‚ËĂ˘â€šÂ¬ÄąÄľĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬ÄąÄľÄ‚â€ąĂ‚Âcznie /settings: czytelnoĂ„â€šĂ˘â‚¬ĹľÄ‚â€žĂ˘â‚¬Â¦Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă„Ä…ÄąĹźÄ‚â€žĂ˘â‚¬ĹˇÄ‚ËĂ˘â€šÂ¬ÄąÄľĂ„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ä‚â€ąĂ˘â‚¬Ë‡ select/input/disabled/dropdown/focus w sekcji Google Calendar reminders.
...
## 2026-06-04 Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ Stage221 owner-control roadmap memory test
...
Runtime tests:
- SKIP Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ etap dokumentacyjny/roadmapowy, bez zmian UI/API/runtime.

Manual test:
- PrzeczytaÄ‚â€žĂ˘â‚¬Ë‡ `_project/07_NEXT_STEPS.md`.
- PotwierdziÄ‚â€žĂ˘â‚¬Ë‡, Ă„Ä…Ă„Ëťe etapy A35 Ă„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬Ă‚Â Ä‚ËĂ˘â€šÂ¬Ă˘â€žË A47 sÄ‚â€žĂ˘â‚¬Â¦ uĂ„Ä…Ă˘â‚¬ĹˇoĂ„Ä…Ă„Ëťone logicznie i zawierajÄ‚â€žĂ˘â‚¬Â¦ cel, zakres, czego nie ruszaÄ‚â€žĂ˘â‚¬Ë‡ oraz guard/test.
- PotwierdziÄ‚â€žĂ˘â‚¬Ë‡, Ă„Ä…Ă„Ëťe Obsidian update zostaĂ„Ä…Ă˘â‚¬Ĺˇ skopiowany do vaulta albo zostaje w `_project/obsidian_updates/`.
...
## STAGE226R10B_LEAD_CLIENT_CONFLICT_SINGLE_DIALOG Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ test history
...
- manual smoke: policzyÄ‚â€žĂ˘â‚¬Ë‡ klientĂ„â€šÄąâ€šw, dodaÄ‚â€žĂ˘â‚¬Ë‡ unikalnego leada, sprawdziÄ‚â€žĂ˘â‚¬Ë‡ Ă„Ä…Ă„Ëťe /clients nie roĂ„Ä…Ă˘â‚¬Ĺźnie; dodaÄ‚â€žĂ˘â‚¬Ë‡ leada podobnego do istniejÄ‚â€žĂ˘â‚¬Â¦cego klienta, sprawdziÄ‚â€žĂ˘â‚¬Ë‡ Ă„Ä…Ă„Ëťe klient nie jest przywracany/tworzony z flow leada.
- status: do wykonania lokalnie po apply.

## STAGE226R10C2_LEAD_CLIENT_CONFLICT_RESTORE_BLOCK_PATCHER_FIX Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ test history
...
- manual smoke: liczba klientĂ„â€šÄąâ€šw przed/po dodaniu leada nie moĂ„Ä…Ă„Ëťe wzrosnÄ‚â€žĂ˘â‚¬Â¦Ä‚â€žĂ˘â‚¬Ë‡; lead podobny do klienta nie przywraca klienta z formularza leada.

## STAGE226R10D2_DUPLICATE_CONFLICT_CONFIRMATION_GATE_PATCHER_FIX Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ test history
...
- manual smoke: dodaj klienta z istniejÄ‚â€žĂ˘â‚¬Â¦cym telefonem/e-mailem Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ musi byÄ‚â€žĂ˘â‚¬Ë‡ komunikat/dialog; Anuluj nie zapisuje; Dodaj mimo to zapisuje. PowtĂ„â€šÄąâ€šrzyÄ‚â€žĂ˘â‚¬Ë‡ dla leada. SprawdziÄ‚â€žĂ˘â‚¬Ë‡, Ă„Ä…Ă„Ëťe lead nadal nie tworzy klienta.

## STAGE226R11_GCAL_TIMEZONE_REMINDER_TRUTH Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ test history
...
- manual smoke: event 12:00 Europe/Warsaw ma byÄ‚â€žĂ˘â‚¬Ë‡ 12:00 w Google; przypomnienie 30 min przed ma byÄ‚â€žĂ˘â‚¬Ë‡ widoczne; inbound nie przesuwa godziny.

## STAGE226R11B_GCAL_TIMEZONE_TEST_CROSS_REALM_FIX Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ historia testĂ„â€šÄąâ€šw

- data i godzina: 2026-06-06 15:05 Europe/Warsaw
- poprzedni FAIL: Google outbound returns wall-clock dateTime plus timeZone, not shifted Z time Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ false negative przez cross-realm object prototype.
...
## 2026-06-06 15:35 Europe/Warsaw Ä‚â€žĂ˘â‚¬ĹˇÄ‚â€ąĂ‚ÂĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬ÄąË‡Ä‚â€šĂ‚Â¬Ä‚ËĂ˘â€šÂ¬ÄąÄ„ STAGE227A test history

Status przed lokalnym uruchomieniem: PENDING_LOCAL_RUN. Skrypt `APPLY_STAGE227A_LOCAL_ONLY.ps1` uruchamia guard, runtime test, build, verify quiet, regresje R10/R11 jeĂ„â€šĂ˘â‚¬ĹľÄ‚â€žĂ˘â‚¬Â¦Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă„Ä…ÄąĹźli istniejÄ‚â€žĂ˘â‚¬ĹˇÄ‚ËĂ˘â€šÂ¬ÄąÄľÄ‚ËĂ˘â€šÂ¬Ă‚Â¦ oraz `git diff --check`.
<!-- STAGE227A_SALES_FUNNEL_MOVEMENT_VIEW_TEST_HISTORY_END -->

<!-- STAGE227B_SALES_FUNNEL_DECISION_LIST_TEST_HISTORY_START -->
## 2026-06-06 15:45 Europe/Warsaw Ä‚â€žĂ˘â‚¬ĹˇÄ‚â€ąĂ‚ÂĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬ÄąË‡Ä‚â€šĂ‚Â¬Ä‚ËĂ˘â€šÂ¬ÄąÄ„ STAGE227B Ä‚â€žĂ˘â‚¬ĹˇÄ‚â€ąĂ‚ÂĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬ÄąË‡Ä‚â€šĂ‚Â¬Ä‚ËĂ˘â€šÂ¬ÄąÄ„ test history

Do wykonania lokalnie: Stage227A guard/test, Stage227B guard/test, build, verify quiet, git diff --check. Manual: `/funnel` ma byÄ‚â€žĂ˘â‚¬ĹˇÄ‚ËĂ˘â€šÂ¬ÄąÄľĂ„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ä‚â€ąĂ˘â‚¬Ë‡ czytelny i ma otworzyÄ‚â€žĂ˘â‚¬ĹˇÄ‚ËĂ˘â€šÂ¬ÄąÄľĂ„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ä‚â€ąĂ˘â‚¬Ë‡ siÄ‚â€žĂ˘â‚¬ĹˇÄ‚ËĂ˘â€šÂ¬ÄąÄľĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬ÄąÄľÄ‚â€ąĂ‚Â bez biaĂ„â€šĂ˘â‚¬ĹľÄ‚â€žĂ˘â‚¬Â¦Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă„Ä…Ă‹â€ˇego ekranu.
<!-- STAGE227B_SALES_FUNNEL_DECISION_LIST_TEST_HISTORY_END -->

<!-- STAGE228A_FUNNEL_TRUTH_CLICKABILITY_TEST_HISTORY_START -->
## 2026-06-06 17:05 Europe/Warsaw Ä‚â€žĂ˘â‚¬ĹˇÄ‚â€ąĂ‚ÂĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬ÄąË‡Ä‚â€šĂ‚Â¬Ä‚ËĂ˘â€šÂ¬ÄąÄ„ STAGE228A test history

Do lokalnego uruchomienia: Stage228A guard/test, regresje Stage227A/B, build, verify quiet i git diff check. Manual: `/funnel` Ä‚â€žĂ˘â‚¬ĹˇÄ‚â€ąĂ‚ÂĂ„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ä‚â€šĂ‚Â Ä‚ËĂ˘â€šÂ¬Ă˘â€žË `PieniÄ‚â€žĂ˘â‚¬ĹˇÄ‚ËĂ˘â€šÂ¬ÄąÄľÄ‚ËĂ˘â€šÂ¬Ă‚Â¦dze` Ä‚â€žĂ˘â‚¬ĹˇÄ‚â€ąĂ‚ÂĂ„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ä‚â€šĂ‚Â Ä‚ËĂ˘â€šÂ¬Ă˘â€žË widoczny rekord Ă„â€šĂ˘â‚¬ĹľÄ‚â€žĂ˘â‚¬Â¦Ă„Ä…ÄąĹşrĂ„â€šĂ˘â‚¬ĹľÄ‚ËĂ˘â€šÂ¬ÄąË‡Ă„Ä…Ă˘â‚¬ĹˇdĂ„â€šĂ˘â‚¬ĹľÄ‚â€žĂ˘â‚¬Â¦Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă„Ä…Ă‹â€ˇowy kwoty.
...
- /cases: Operacyjne skrĂ„â€šÄąâ€šty tone intensity matches /clients and /leads Filtry proste.
...
Tests:
- node --check Stage230B/230C/R2/R10 guardĂ„â€šÄąâ€šw i testĂ„â€šÄąâ€šw
- node scripts/check-stage230b-quick-capture-inbox.cjs
- node --test tests/stage230b-quick-capture-inbox.test.cjs
- node scripts/check-stage230c-phone-dictation-duplicate-words-audit.cjs
- node --test tests/stage230c-phone-dictation-duplicate-words-audit.test.cjs
...
- e-mail/hasĂ„Ä…Ă˘â‚¬Ĺˇo rejestracji nadal widoczne
- reset hasĂ„Ä…Ă˘â‚¬Ĺˇa nadal widoczny
<!-- STAGE231A_GOOGLE_AUTH_ENTRY_CONSISTENCY_TEST_HISTORY_END -->

## STAGE231D_GOOGLE_AUTH_INTENT_GATE Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ planned verification
...
## 2026-06-10 Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ STAGE231B0 tests
...
## 2026-06-10 Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ STAGE231B0-R7 test plan
...
## 2026-06-10 17:10 Europe/Warsaw Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ STAGE231D0A Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ test history
...
Warunek PASS:
- D0A ma mapÄ‚â€žĂ˘â€žË Visual Source of Truth,
- roadmapa zawiera D0A przed D0,
- istniejÄ‚â€žĂ˘â‚¬Â¦cy UI korzysta z wykrytych Ă„Ä…ÄąĹşrĂ„â€šÄąâ€šdeĂ„Ä…Ă˘â‚¬Ĺˇ prawdy,
- dokumentacja i payload Obsidiana nie zawierajÄ‚â€žĂ˘â‚¬Â¦ mojibake.
<!-- STAGE231D0A_VISUAL_SOURCE_TRUTH_TEST_HISTORY_END -->

<!-- STAGE231D0A_R3_GUARD_PAYLOAD_EOF_RESCUE_TEST_HISTORY_START -->
## STAGE231D0A-R3 Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ test history
...
## 2026-06-10 20:05 Europe/Warsaw Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ STAGE231D3-R7 planned test result
...
- git diff --check
- npm run build
- rÄ‚â€žĂ˘â€žËcznie /clients: brak krzakĂ„â€šÄąâ€šw, brak Leady:, brak Aktywna sprawa, poprawne Zarobione Ă„Ä…Ă˘â‚¬ĹˇÄ‚â€žĂ˘â‚¬Â¦cznie.
...
## 2026-06-12 15:00 Europe/Warsaw Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ STAGE231D0F test history
...
Manual QA:
1. WejĂ„Ä…Ă˘â‚¬ĹźÄ‚â€žĂ˘â‚¬Ë‡ w `/funnel`.
2. SprawdziÄ‚â€žĂ˘â‚¬Ë‡ gĂ„â€šÄąâ€šrne kafle: ruch, brak kroku, cisza, ryzyko, pieniÄ‚â€žĂ˘â‚¬Â¦dze.
3. KlikniÄ‚â€žĂ˘â€žËcie kafla filtruje rekordy.
4. Pasek etapĂ„â€šÄąâ€šw jest niĂ„Ä…Ă„Ëťszy i nie dominuje.
5. KlikniÄ‚â€žĂ˘â€žËcie etapu filtruje rekordy.
6. Lista rekordĂ„â€šÄąâ€šw jest czytelna.
7. Prawy rail jest lekki.
8. Nie pojawiĂ„Ä…Ă˘â‚¬Ĺˇ siÄ‚â€žĂ˘â€žË kanban.
...
## 2026-06-12 Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ STAGE231D0G-CLOSEOUT test history

Result:
PASS / CLOSED

Commands:
- `node scripts/check-stage231d0g-visual-tile-source-truth-atlas.cjs` Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ PASS
- `node --test tests/stage231d0g-visual-tile-source-truth-atlas.test.cjs` Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ PASS
- `node scripts/check-stage231d0f-r13-funnel-visual-color-density.cjs` Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ PASS
- `node --test tests/stage231d0f-r13-funnel-visual-color-density.test.cjs` Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ PASS
- `npm run build` Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ PASS
- `git diff --check` Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ PASS, non-blocking LF/CRLF warnings allowed
...
Do wykonania po apply:
1. Dodaj nowego leada z PotencjaĂ„Ä…Ă˘â‚¬Ĺˇ / wartoĂ„Ä…Ă˘â‚¬ĹźÄ‚â€žĂ˘â‚¬Ë‡ = 12000.
2. OtwĂ„â€šÄąâ€šrz kartÄ‚â€žĂ˘â€žË leada i sprawdĂ„Ä…ÄąĹş, czy kafelek PotencjaĂ„Ä…Ă˘â‚¬Ĺˇ pokazuje 12 000 PLN.
3. Edytuj potencjaĂ„Ä…Ă˘â‚¬Ĺˇ z kafelka i z panelu Finanse leada.
4. Hard refresh: wartoĂ„Ä…Ă˘â‚¬ĹźÄ‚â€žĂ˘â‚¬Ë‡ zostaje.
5. Dodaj zadanie, wydarzenie i brak; sprawdĂ„Ä…ÄąĹş layout wierszy i akcje Jutro/Zrobione/RozwiÄ‚â€žĂ˘â‚¬Â¦Ă„Ä…Ă„Ëť brak/UsuĂ„Ä…Ă˘â‚¬Ĺľ.

## 2026-06-14 10:40 Europe/Warsaw - STAGE231G R6 validation

Do przejĂ„Ä…Ă˘â‚¬Ĺźcia przed push:
...
Do wykonania:
1. Kliknij Edytuj/Ustaw potencjaĂ„Ä…Ă˘â‚¬Ĺˇ na kafelku PotencjaĂ„Ä…Ă˘â‚¬Ĺˇ.
2. Modal ma zawieraÄ‚â€žĂ˘â‚¬Ë‡ tylko pole PotencjaĂ„Ä…Ă˘â‚¬Ĺˇ / wartoĂ„Ä…Ă˘â‚¬ĹźÄ‚â€žĂ˘â‚¬Ë‡, podsumowanie, Anuluj i Zapisz potencjaĂ„Ä…Ă˘â‚¬Ĺˇ.
3. Wpisz nowÄ‚â€žĂ˘â‚¬Â¦ wartoĂ„Ä…Ă˘â‚¬ĹźÄ‚â€žĂ˘â‚¬Ë‡, zapisz, zrĂ„â€šÄąâ€šb hard refresh.
4. Kafelek PotencjaĂ„Ä…Ă˘â‚¬Ĺˇ i Finanse leada pokazujÄ‚â€žĂ˘â‚¬Â¦ nowÄ‚â€žĂ˘â‚¬Â¦ wartoĂ„Ä…Ă˘â‚¬ĹźÄ‚â€žĂ˘â‚¬Ë‡.
5. W sekcji NajbliĂ„Ä…Ă„Ëťsze dziaĂ„Ä…Ă˘â‚¬Ĺˇania przyciski, w tym Zrobione, sÄ‚â€žĂ˘â‚¬Â¦ wyrĂ„â€šÄąâ€šwnane na desktopie.
...
Plan testĂ„â€šÄąâ€šw:
- guard R1/R1B/R1C,
- test R1C,
- build,
- rÄ‚â€žĂ˘â€žËcznie: dodaj koszt -> okno `Koryguj wpĂ„Ä…Ă˘â‚¬ĹˇatÄ‚â€žĂ˘â€žË/koszt` -> koszt widoczny na czerwono -> korekta kwoty/statusu -> refresh -> summary siÄ‚â€žĂ˘â€žË zmienia,
- rÄ‚â€žĂ˘â€žËcznie: usuĂ„Ä…Ă˘â‚¬Ĺľ koszt -> refresh -> koszt nie wraca.
...
## STAGE231H_R1G3_CASE_DETAIL_MANUAL_UI_PASS Ä‚ËĂ˘â€šÂ¬Ă˘â‚¬ĹĄ manual UI test result
