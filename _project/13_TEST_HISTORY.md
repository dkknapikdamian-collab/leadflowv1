...
-
pm run build
- RĂ„â€šĂ˘â‚¬ĹľÄ‚ËĂ˘â‚¬ĹľĂ‹Âcznie /settings: czytelnoÄ‚â€žĂ„â€¦Ä‚ËĂ˘â€šÂ¬ÄąĹşĂ„â€šĂ˘â‚¬ĹľÄ‚ËĂ˘â€šÂ¬Ă‹â€ˇ select/input/disabled/dropdown/focus w sekcji Google Calendar reminders.
...
## 2026-06-04 Ă˘â‚¬â€ť Stage221 owner-control roadmap memory test
...
Runtime tests:
- SKIP Ă˘â‚¬â€ť etap dokumentacyjny/roadmapowy, bez zmian UI/API/runtime.

Manual test:
- PrzeczytaĂ„â€ˇ `_project/07_NEXT_STEPS.md`.
- PotwierdziĂ„â€ˇ, ÄąÄ˝e etapy A35 Ä‚ËĂ˘â‚¬Â Ă˘â‚¬â„˘ A47 sĂ„â€¦ uÄąâ€šoÄąÄ˝one logicznie i zawierajĂ„â€¦ cel, zakres, czego nie ruszaĂ„â€ˇ oraz guard/test.
- PotwierdziĂ„â€ˇ, ÄąÄ˝e Obsidian update zostaÄąâ€š skopiowany do vaulta albo zostaje w `_project/obsidian_updates/`.
...
## STAGE226R10B_LEAD_CLIENT_CONFLICT_SINGLE_DIALOG Ă˘â‚¬â€ť test history
...
- manual smoke: policzyĂ„â€ˇ klientÄ‚Ĺ‚w, dodaĂ„â€ˇ unikalnego leada, sprawdziĂ„â€ˇ ÄąÄ˝e /clients nie roÄąâ€şnie; dodaĂ„â€ˇ leada podobnego do istniejĂ„â€¦cego klienta, sprawdziĂ„â€ˇ ÄąÄ˝e klient nie jest przywracany/tworzony z flow leada.
- status: do wykonania lokalnie po apply.

## STAGE226R10C2_LEAD_CLIENT_CONFLICT_RESTORE_BLOCK_PATCHER_FIX Ă˘â‚¬â€ť test history
...
- manual smoke: liczba klientÄ‚Ĺ‚w przed/po dodaniu leada nie moÄąÄ˝e wzrosnĂ„â€¦Ă„â€ˇ; lead podobny do klienta nie przywraca klienta z formularza leada.

## STAGE226R10D2_DUPLICATE_CONFLICT_CONFIRMATION_GATE_PATCHER_FIX Ă˘â‚¬â€ť test history
...
- manual smoke: dodaj klienta z istniejĂ„â€¦cym telefonem/e-mailem Ă˘â‚¬â€ť musi byĂ„â€ˇ komunikat/dialog; Anuluj nie zapisuje; Dodaj mimo to zapisuje. PowtÄ‚Ĺ‚rzyĂ„â€ˇ dla leada. SprawdziĂ„â€ˇ, ÄąÄ˝e lead nadal nie tworzy klienta.

## STAGE226R11_GCAL_TIMEZONE_REMINDER_TRUTH Ă˘â‚¬â€ť test history
...
- manual smoke: event 12:00 Europe/Warsaw ma byĂ„â€ˇ 12:00 w Google; przypomnienie 30 min przed ma byĂ„â€ˇ widoczne; inbound nie przesuwa godziny.

## STAGE226R11B_GCAL_TIMEZONE_TEST_CROSS_REALM_FIX Ă˘â‚¬â€ť historia testÄ‚Ĺ‚w

- data i godzina: 2026-06-06 15:05 Europe/Warsaw
- poprzedni FAIL: Google outbound returns wall-clock dateTime plus timeZone, not shifted Z time Ă˘â‚¬â€ť false negative przez cross-realm object prototype.
...
## 2026-06-06 15:35 Europe/Warsaw Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă˘â‚¬ĹĄ STAGE227A test history

Status przed lokalnym uruchomieniem: PENDING_LOCAL_RUN. Skrypt `APPLY_STAGE227A_LOCAL_ONLY.ps1` uruchamia guard, runtime test, build, verify quiet, regresje R10/R11 jeÄ‚â€žĂ„â€¦Ä‚ËĂ˘â€šÂ¬ÄąĹşli istniejĂ„â€šĂ˘â‚¬ĹľĂ˘â‚¬Â¦ oraz `git diff --check`.
<!-- STAGE227A_SALES_FUNNEL_MOVEMENT_VIEW_TEST_HISTORY_END -->

<!-- STAGE227B_SALES_FUNNEL_DECISION_LIST_TEST_HISTORY_START -->
## 2026-06-06 15:45 Europe/Warsaw Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă˘â‚¬ĹĄ STAGE227B Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă˘â‚¬ĹĄ test history

Do wykonania lokalnie: Stage227A guard/test, Stage227B guard/test, build, verify quiet, git diff --check. Manual: `/funnel` ma byĂ„â€šĂ˘â‚¬ĹľÄ‚ËĂ˘â€šÂ¬Ă‹â€ˇ czytelny i ma otworzyĂ„â€šĂ˘â‚¬ĹľÄ‚ËĂ˘â€šÂ¬Ă‹â€ˇ siĂ„â€šĂ˘â‚¬ĹľÄ‚ËĂ˘â‚¬ĹľĂ‹Â bez biaÄ‚â€žĂ„â€¦Ä‚ËĂ˘â€šÂ¬ÄąË‡ego ekranu.
<!-- STAGE227B_SALES_FUNNEL_DECISION_LIST_TEST_HISTORY_END -->

<!-- STAGE228A_FUNNEL_TRUTH_CLICKABILITY_TEST_HISTORY_START -->
## 2026-06-06 17:05 Europe/Warsaw Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă˘â‚¬ĹĄ STAGE228A test history

Do lokalnego uruchomienia: Stage228A guard/test, regresje Stage227A/B, build, verify quiet i git diff check. Manual: `/funnel` Ă„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬Ă‚Â Ă˘â‚¬â„˘ `PieniĂ„â€šĂ˘â‚¬ĹľĂ˘â‚¬Â¦dze` Ă„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬Ă‚Â Ă˘â‚¬â„˘ widoczny rekord Ä‚â€žĂ„â€¦ÄąĹźrÄ‚â€žĂ˘â‚¬ĹˇÄąâ€šdÄ‚â€žĂ„â€¦Ä‚ËĂ˘â€šÂ¬ÄąË‡owy kwoty.
...
- /cases: Operacyjne skrÄ‚Ĺ‚ty tone intensity matches /clients and /leads Filtry proste.
...
Tests:
- node --check Stage230B/230C/R2/R10 guardÄ‚Ĺ‚w i testÄ‚Ĺ‚w
- node scripts/check-stage230b-quick-capture-inbox.cjs
- node --test tests/stage230b-quick-capture-inbox.test.cjs
- node scripts/check-stage230c-phone-dictation-duplicate-words-audit.cjs
- node --test tests/stage230c-phone-dictation-duplicate-words-audit.test.cjs
...
- e-mail/hasÄąâ€šo rejestracji nadal widoczne
- reset hasÄąâ€ša nadal widoczny
<!-- STAGE231A_GOOGLE_AUTH_ENTRY_CONSISTENCY_TEST_HISTORY_END -->

## STAGE231D_GOOGLE_AUTH_INTENT_GATE Ă˘â‚¬â€ť planned verification
...
## 2026-06-10 Ă˘â‚¬â€ť STAGE231B0 tests
...
## 2026-06-10 Ă˘â‚¬â€ť STAGE231B0-R7 test plan
...
## 2026-06-10 17:10 Europe/Warsaw Ă˘â‚¬â€ť STAGE231D0A Ă˘â‚¬â€ť test history
...
Warunek PASS:
- D0A ma mapĂ„â„˘ Visual Source of Truth,
- roadmapa zawiera D0A przed D0,
- istniejĂ„â€¦cy UI korzysta z wykrytych ÄąĹźrÄ‚Ĺ‚deÄąâ€š prawdy,
- dokumentacja i payload Obsidiana nie zawierajĂ„â€¦ mojibake.
<!-- STAGE231D0A_VISUAL_SOURCE_TRUTH_TEST_HISTORY_END -->

<!-- STAGE231D0A_R3_GUARD_PAYLOAD_EOF_RESCUE_TEST_HISTORY_START -->
## STAGE231D0A-R3 Ă˘â‚¬â€ť test history
...
## 2026-06-10 20:05 Europe/Warsaw Ă˘â‚¬â€ť STAGE231D3-R7 planned test result
...
- git diff --check
- npm run build
- rĂ„â„˘cznie /clients: brak krzakÄ‚Ĺ‚w, brak Leady:, brak Aktywna sprawa, poprawne Zarobione Äąâ€šĂ„â€¦cznie.
...
## 2026-06-12 15:00 Europe/Warsaw Ă˘â‚¬â€ť STAGE231D0F test history
...
Manual QA:
1. WejÄąâ€şĂ„â€ˇ w `/funnel`.
2. SprawdziĂ„â€ˇ gÄ‚Ĺ‚rne kafle: ruch, brak kroku, cisza, ryzyko, pieniĂ„â€¦dze.
3. KlikniĂ„â„˘cie kafla filtruje rekordy.
4. Pasek etapÄ‚Ĺ‚w jest niÄąÄ˝szy i nie dominuje.
5. KlikniĂ„â„˘cie etapu filtruje rekordy.
6. Lista rekordÄ‚Ĺ‚w jest czytelna.
7. Prawy rail jest lekki.
8. Nie pojawiÄąâ€š siĂ„â„˘ kanban.
...
## 2026-06-12 Ă˘â‚¬â€ť STAGE231D0G-CLOSEOUT test history

Result:
PASS / CLOSED

Commands:
- `node scripts/check-stage231d0g-visual-tile-source-truth-atlas.cjs` Ă˘â‚¬â€ť PASS
- `node --test tests/stage231d0g-visual-tile-source-truth-atlas.test.cjs` Ă˘â‚¬â€ť PASS
- `node scripts/check-stage231d0f-r13-funnel-visual-color-density.cjs` Ă˘â‚¬â€ť PASS
- `node --test tests/stage231d0f-r13-funnel-visual-color-density.test.cjs` Ă˘â‚¬â€ť PASS
- `npm run build` Ă˘â‚¬â€ť PASS
- `git diff --check` Ă˘â‚¬â€ť PASS, non-blocking LF/CRLF warnings allowed
...
Do wykonania po apply:
1. Dodaj nowego leada z PotencjaÄąâ€š / wartoÄąâ€şĂ„â€ˇ = 12000.
2. OtwÄ‚Ĺ‚rz kartĂ„â„˘ leada i sprawdÄąĹź, czy kafelek PotencjaÄąâ€š pokazuje 12 000 PLN.
3. Edytuj potencjaÄąâ€š z kafelka i z panelu Finanse leada.
4. Hard refresh: wartoÄąâ€şĂ„â€ˇ zostaje.
5. Dodaj zadanie, wydarzenie i brak; sprawdÄąĹź layout wierszy i akcje Jutro/Zrobione/RozwiĂ„â€¦ÄąÄ˝ brak/UsuÄąâ€ž.

## 2026-06-14 10:40 Europe/Warsaw - STAGE231G R6 validation

Do przejÄąâ€şcia przed push:
...
Do wykonania:
1. Kliknij Edytuj/Ustaw potencjaÄąâ€š na kafelku PotencjaÄąâ€š.
2. Modal ma zawieraĂ„â€ˇ tylko pole PotencjaÄąâ€š / wartoÄąâ€şĂ„â€ˇ, podsumowanie, Anuluj i Zapisz potencjaÄąâ€š.
3. Wpisz nowĂ„â€¦ wartoÄąâ€şĂ„â€ˇ, zapisz, zrÄ‚Ĺ‚b hard refresh.
4. Kafelek PotencjaÄąâ€š i Finanse leada pokazujĂ„â€¦ nowĂ„â€¦ wartoÄąâ€şĂ„â€ˇ.
5. W sekcji NajbliÄąÄ˝sze dziaÄąâ€šania przyciski, w tym Zrobione, sĂ„â€¦ wyrÄ‚Ĺ‚wnane na desktopie.
...
- test R1C,
- build,
- rĂ„â„˘cznie: dodaj koszt -> okno `Koryguj wpÄąâ€šatĂ„â„˘/koszt` -> koszt widoczny na czerwono -> korekta kwoty/statusu -> refresh -> summary siĂ„â„˘ zmienia,
- rĂ„â„˘cznie: usuÄąâ€ž koszt -> refresh -> koszt nie wraca.
...
## STAGE231H_R1G3_CASE_DETAIL_MANUAL_UI_PASS Ă˘â‚¬â€ť manual UI test result
