...
| `/notifications` | `src/pages/NotificationsCenter.tsx` | unread, alerts, system, risk notifications | notification severity cards | CloseFlowMetricTileV2 + AlertSeverityCard | WAVE 2 / MEDIUM | Severity tones must map to amber/red/neutral. |
