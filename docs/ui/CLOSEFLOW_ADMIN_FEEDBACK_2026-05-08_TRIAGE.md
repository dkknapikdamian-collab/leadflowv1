...
| `/leads` | `aside.right-card.lead-right-card.operator-top-value-card` | `right-card lead-right-card operator-top-value-card` | Kolory w prawym panelu relacji. | surface / right-card / right-rail | Etap 1 | globalny kontrakt powierzchni |
