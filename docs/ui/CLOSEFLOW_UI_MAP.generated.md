...
Generated: 2026-08-27T22:08:01.355Z
...
- Bezpośrednie importy ikon z lucide-react: **434**
...
| navigation | 41 | ArrowRight (src/components/EntityConflictDialog.tsx:2, użycia: 1)<br>ChevronDown (src/components/GlobalQuickActions.tsx:3, użycia: 1)<br>ChevronRight (src/components/Layout.tsx:10, użycia: 1)<br>ChevronLeft (src/components/sidebar-mini-calendar.tsx:3, użycia: 1)<br>ChevronRight (src/components/sidebar-mini-calendar.tsx:3, użycia: 1)<br>ChevronDown (src/components/TaskCreateDialog.tsx:2, użycia: 5)<br>ChevronDown (src/components/topic-contact-picker.tsx:2, użycia: 1)<br>ChevronRight (src/components/ui/dropdown-menu.tsx:3, użycia: 1)<br>ChevronDownIcon (src/components/ui/select.tsx:5, użycia: 2)<br>ChevronUpIcon (src/components/ui/select.tsx:5, użycia: 1)<br>ArrowLeft (src/components/ui-system/action-icon-registry.ts:1, użycia: 0)<br>ExternalLink (src/components/ui-system/action-icon-registry.ts:1, użycia: 0) |
