...
create table if not exists public.cases (
  ...
  title text not null,
  description text not null default '',
  operational_status text not null default 'intake' check (operational_status in ('draft', 'intake', 'waiting_client', 'in_progress', 'ready_to_start', 'blocked', 'done', 'archived')),
