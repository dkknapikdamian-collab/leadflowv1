...
function fail(message) {
  console.error('FAIL check:case-detail-history-visual-p1-repair4:', message);
  process.exit(1);
}
...
for (const token of [
  'CLOSEFLOW_CASE_DETAIL_HISTORY_VISUAL_P1_REPAIR4_2026_05_13',
...
console.log('OK check:case-detail-history-visual-p1-repair4');
