...
const activityHistoryOutsideNotes =
  lead.includes('data-stage216j3g-activity-history-section="true"') ||
...
check("activity history is not mixed into notes section", activityHistoryOutsideNotes);
