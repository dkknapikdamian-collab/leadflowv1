...
check("activity history section exists", lead.includes('data-stage216j3g-activity-history-section="true"'));
check("activity history is collapsible", lead.includes("<details className=\"lead-detail-activity-history-details\">"));
check("activity history uses non-note source", lead.includes("leadActivityHistoryItems.slice(0, 5).map"));
