...
contains('scripts/check-stage58-case-recent-moves-panel.cjs', 'check:stage59-case-note-follow-up-prompt && npm.cmd run check:stage60-case-action-copy-note-dedupe && npm.cmd run verify:client-detail-operational-ui', 'Stage58 guard compat');
...
contains('package.json', 'check:stage58-case-recent-moves-panel && npm.cmd run check:stage59-case-note-follow-up-prompt && npm.cmd run check:stage60-case-action-copy-note-dedupe && npm.cmd run verify:client-detail-operational-ui', 'Stage59 included in case operational verify');
