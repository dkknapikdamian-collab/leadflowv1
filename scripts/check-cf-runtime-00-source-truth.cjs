...
const allowedChangePrefixes = [
  ...
  '_project/runs/STAGE232I2_R4_CLIENT_MISSING_DELETE_NO_DELETE_ROUTE.md',
  'tests/stage232i2-r4-client-missing-delete-no-delete-route.test.cjs',
  'scripts/check-stage232i2-r4-client-missing-delete-no-delete-route.cjs',
