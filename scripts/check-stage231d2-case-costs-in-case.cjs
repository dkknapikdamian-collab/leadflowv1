...
if(!errors.length){
 ...
 has('src/lib/supabase-fallback.ts', '/api/case-costs');
 has('api/case-costs.ts', 'resolveRequestWorkspaceId');
 has('api/case-costs.ts', 'case_costs');
 ...
 has('_project/runs/STAGE231D2_CASE_COSTS_IN_CASE_RUN.md', 'audyt ryzyk');
 has('_project/runs/STAGE231D2_CASE_COSTS_IN_CASE_RUN.md', 'następny krok');
 has('_project/obsidian_payloads/STAGE231D2_CASE_COSTS_IN_CASE_OBSIDIAN_PAYLOAD.md', 'SQL');
 has('_project/runs/STAGE231D2_R2_CASE_COSTS_FETCH_GUARD_CLOSE_RUN.md', 'audyt ryzyk');
 has('_project/runs/STAGE231D2_R2_CASE_COSTS_FETCH_GUARD_CLOSE_RUN.md', 'następny krok');
}
