...
function fail(message) {
  console.error(`FAIL STAGE227E4R2_DECISION_VIEW_SIMPLIFICATION: ${message}`);
  process.exit(1);
}
...
mustContain(css, 'STAGE227E4R2_DECISION_VIEW_SIMPLIFICATION_CSS', 'R2 CSS marker');
...
console.log('PASS STAGE227E4R2_DECISION_VIEW_SIMPLIFICATION');
