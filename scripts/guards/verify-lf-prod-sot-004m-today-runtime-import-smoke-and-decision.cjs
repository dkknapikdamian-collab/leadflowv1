...
const allowedFutureStagePrefixes = [
  ...
  'src/lib/source-of-truth/list-cards-status-date-readonly-runtime.ts',

  'src/lib/clients.ts',

  'src/lib/cases.ts',

  '_project/runs/LF-PROD-SOT-004P_',

  'scripts/guards/verify-lf-prod-sot-004p-',

  'tests/lf-prod-sot-004p-',
