...
const OBSIDIAN_SCOPE_PATH_G6 = '10_PROJEKTY/CloseFlow_Lead_App/04_NAPRAWA_ZRODLA_PRAWDY';
...
const requiredDecisionTokens = [
  ...
  `OBSIDIAN_SCOPE_PATH_G6: ${OBSIDIAN_SCOPE_PATH_G6}`,
...
assertAllowed(changedFilesSinceScoped(vault, OBSIDIAN_INPUT_HEAD_G6, OBSIDIAN_SCOPE_PATH_G6), allowedVault, 'vault');
assertG7Absent();
...
console.log('OBSIDIAN_SCOPE_POLICY_G6: CLOSEFLOW_PROJECT_PATH_ONLY');
console.log(`OBSIDIAN_SCOPE_PATH_G6: ${OBSIDIAN_SCOPE_PATH_G6}`);
