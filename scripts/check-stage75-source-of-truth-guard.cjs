...
requireIncludes("STAGE75_SOURCE_OF_TRUTH_GUARD", "src/lib/plans.ts", ["TRIAL_DAYS = 14", "PLAN_FEATURE_MINIMUM_PLANS", "googleCalendar: PLAN_IDS.pro", "fullAi: PLAN_IDS.ai"]);
