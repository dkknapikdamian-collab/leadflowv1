...
expectIncludes('src/pages/Clients.tsx', "import ClientCreateDialog from '../components/ClientCreateDialog';", 'Clients mounts the canonical client-create dialog');
...
expectIncludes('src/pages/Clients.tsx', 'isArchivedStage025', 'trash view remains present');
expectIncludes('src/pages/Clients.tsx', "query.get('frt025') === 'archived'", 'trash view route remains present');
expectIncludes('src/pages/Clients.tsx', 'filteredArchivedRowsStage025', 'trash view filtering remains present');
expectIncludes('src/pages/Clients.tsx', 'setSearch', 'search remains present');
expectIncludes('src/pages/Clients.tsx', "to={'/clients/' + client.id}", 'ClientDetail link remains present');
