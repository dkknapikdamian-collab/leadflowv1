...
if (!clientCss.includes('STAGE231B0_R11_CLIENT_WIDTH_AND_CASES_RUNTIME_GUARD')) fail('ClientDetail R11 CSS marker missing');
if (!clientCss.includes('max-width: none !important;')) fail('ClientDetail no max-width clamp missing');
