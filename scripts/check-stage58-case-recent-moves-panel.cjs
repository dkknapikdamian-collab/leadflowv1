...
contains('package.json', 'check:stage58-case-recent-moves-panel && npm.cmd run verify:client-detail-operational-ui', 'Stage58 included in case operational verify');
