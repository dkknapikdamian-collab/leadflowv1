...
contains('src/pages/CaseDetail.tsx', 'data-case-create-action="note"', 'note action button');
...
contains('package.json', 'check:stage57-case-create-action-hub && npm.cmd run verify:client-detail-operational-ui', 'Stage57 included in case operational verify');
