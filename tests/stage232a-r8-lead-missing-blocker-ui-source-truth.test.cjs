...
test('STAGE232A R8 next actions exclude Brak task ids and Braki group counts all missing', () => {
  const lead = read('src/pages/LeadDetail.tsx');
...
test('STAGE232A R8 activity/task bridges preserve blocker identity', () => {
