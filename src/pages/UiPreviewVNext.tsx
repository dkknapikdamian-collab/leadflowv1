      ...
      <div className="cfv-layout">
        ...
        <main className="cfv-main">
          ...
          <div className="cfv-layout-list">
            <div className="cfv-stack">
              <div className="cfv-search cf-main-search" data-cf-main-search-source="semantic173"><span>⌕</span><input placeholder="Szukaj: nazwa, telefon, e-mail, firma, źródło albo sprawa..." /></div>
