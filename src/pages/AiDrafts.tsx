      ...
      <div className="ai-drafts-relation-picker" data-ai-draft-relation-picker={kind}>
        ...
        <div className="ai-drafts-relation-options">
          ...
          {!approvalRelationsLoading && visibleOptions.length === 0 ? (
            <p className="ai-drafts-relation-empty">Ładuję dane z bazy...</p>
          ) : null}
    ...
    <Layout>
      <main className="ai-drafts-vnext-page" data-ai-drafts-stage={AI_DRAFT_STAGE9_MARKER} data-ai-draft-command-center="true">
        ...
        <section className="ai-drafts-stats-grid" aria-label="Statystyki szkiców AI" data-ai-draft-stats="true">
          ...
          <MetricCard label="Zatwierdzone" value={stats.converted} icon={CheckCircle2} tone="done" active={activeFilter === 'converted'} onClick={() => setActiveFilter('converted')} dataTab="converted" />
        </section>
...
/* STAGE16M_AI_DRAFTS_COMMAND_CENTER_COMPAT
Centrum szkiców
