...
const CLOSEFLOW_STAGE181AA_ADMIN_AI_SETTINGS_RUNTIME_GUARD = true;
        ...
        <Card className="cf-readable-card border-none app-surface-strong">
          ...
          <CardContent className="grid gap-4 md:grid-cols-4">
            ...
            <div className="cf-readable-panel rounded-2xl border border-slate-200 p-4">
              ...
              <p className="mt-2 text-lg font-bold app-text">{aiDiagnostics.enabled ? 'Włączone' : 'Wymaga konfiguracji'}</p>
            </div>
            <div className="cf-readable-panel rounded-2xl border border-slate-200 p-4">
              <p className="text-xs font-bold uppercase tracking-[0.18em] app-muted">Quick Capture</p>
              <p className="mt-2 text-lg font-bold app-text">{aiDiagnostics.quickLeadCaptureEnabled ? 'Beta' : 'W przygotowaniu'}</p>
            </div>
            <div className="cf-readable-panel rounded-2xl border border-slate-200 p-4">
              <p className="text-xs font-bold uppercase tracking-[0.18em] app-muted">Główny provider</p>
              <p className="mt-2 text-lg font-bold app-text">{aiDiagnostics.primaryProvider || 'Wymaga konfiguracji'}</p>
            </div>
            <div className="cf-readable-panel rounded-2xl border border-slate-200 p-4">
              <p className="text-xs font-bold uppercase tracking-[0.18em] app-muted">TTL szkicu</p>
              <p className="mt-2 text-lg font-bold app-text">{aiDiagnostics.draftTtlHours || 24} h</p>
            </div>
          </CardContent>
        </Card>
