...
import { Bell, Clock3, Settings2, ShieldAlert, Trash2 } from 'lucide-react';
      ...
      <div className="p-4 md:p-8 max-w-6xl mx-auto w-full space-y-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <Card className="border-none shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-lg"><Settings2 className="w-5 h-5 text-slate-400" /> Sterowanie powiadomieniami</CardTitle>
              <CardDescription>Włączanie i wyłączanie powiadomień przenieśliśmy do Ustawienia → Ustawienia aplikacji.</CardDescription>
            </CardHeader>
              ...
              <div className="rounded-2xl border border-slate-200 p-4">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  {permission === 'unsupported'
                    ...
                    : permission === 'granted'
                      ? 'Powiadomienia przeglądarki są już włączone.'
                      : permission === 'denied'
                        ? 'Powiadomienia są zablokowane w przeglądarce.'
                        : 'Powiadomienia nie są jeszcze zatwierdzone.'}
                </p>
                <p className="mt-2 text-sm text-slate-500">
                  Live powiadomienia: {browserEnabled ? 'włączone' : 'wyłączone'}
                </p>
              </div>

              <Link to="/settings" className="block">
                <Button className="w-full">Przejdź do ustawień aplikacji</Button>
              </Link>
            </CardContent>
          </Card>
        </div>
