...
export default function ContextActionDialogsHost() {
  ...
  useEffect(() => {
    const capture = (event: MouseEvent) => {
      ...
      const context = buildContextFromPath(location.pathname);
      if (!context) return;
  ...
  return (
    <div data-context-action-dialog-host="true" data-stage="stage85-context-action-dialog-unification" style={{ display: 'contents' }}>
