  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      <main className="flex-1 flex flex-col min-w-0 relative">
        <div className="fixed top-4 right-4 z-[100] rounded-lg border border-rose-700 bg-rose-600 px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-white shadow-lg">
          TEST
        </div>
