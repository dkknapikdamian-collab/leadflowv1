...
type ClientUpsertInput = { id?: string; name?: string; company?: string; email?: string; phone?: string; notes?: string; tags?: string[]; sourcePrimary?: string; lastActivityAt?: string | null; archivedAt?: string | null; primaryCaseId?: string | null; workspaceId?: string; allowDuplicate?: boolean; forceDuplicate?: boolean };
