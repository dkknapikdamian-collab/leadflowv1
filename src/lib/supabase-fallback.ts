...
type MeResponse = {
  workspace: { id: string; ownerId?: string | null; planId?: string | null; subscriptionStatus?: string | null; trialEndsAt?: string | null; billingProvider?: string | null; providerCustomerId?: string | null; providerSubscriptionId?: string | null; nextBillingAt?: string | null; cancelAtPeriodEnd?: boolean; dailyDigestEnabled?: boolean; dailyDigestHour?: number; dailyDigestTimezone?: string | null; dailyDigestRecipientEmail?: string | null; timezone?: string | null; ownerControlWarningDays?: number; ownerControlCriticalDays?: number; ownerControlHighValueThresholdPln?: number } | null;
  profile: { id: string; fullName?: string; companyName?: string; email?: string; role?: string; workspaceRole?: 'owner' | 'admin' | 'member'; isWorkspaceOwner?: boolean; isWorkspaceAdmin?: boolean; isAdmin?: boolean; isAppOwner?: boolean; appRole?: string; appearanceSkin?: string; planningConflictWarningsEnabled?: boolean; browserNotificationsEnabled?: boolean; forceLogoutAfter?: string | null };
  workspaceMembership?: { id?: string | null; workspaceId: string; userId: string; role: 'owner' | 'admin' | 'member' };
