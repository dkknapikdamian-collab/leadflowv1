...
export const CLOSEFLOW_VISUAL_SOURCE_TRUTH: Record<CloseFlowVisualKind, CloseFlowVisualToken> = {
  ...
  delete: { label: 'Usuń', colorVar: '--cf-vst-color-delete', softVar: '--cf-vst-color-delete-soft', borderVar: '--cf-vst-color-delete-border', className: 'cf-vst-kind-delete', iconHint: 'delete' },
  destructive: { label: 'Destrukcja', colorVar: '--cf-vst-color-delete', softVar: '--cf-vst-color-delete-soft', borderVar: '--cf-vst-color-delete-border', className: 'cf-vst-kind-delete', iconHint: 'delete' },
