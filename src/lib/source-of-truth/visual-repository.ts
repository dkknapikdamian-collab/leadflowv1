/* LF-UI-SOT-007 compatibility note:
   LF-PROD-SOT-003B remains a legacy read-only contract and is not a runtime visual owner.
   Current runtime ownership is defined only by visual-owner-registry.json and its reachable graph.
*/
...
export const visualTokenSourceMap = {
  ...
  globalTokenSources: [
    'src/index.css',
    'src/styles/owners/closeflow-foundation.css',
...
export const globalVisualContract: VisualContract = {
  ...
  tokenSources: ['src/styles/owners/closeflow-foundation.css', 'src/styles/design-system/closeflow-icons.css'],
...
export const formFieldVisualContract: VisualContract = {
  ...
  sourceFiles: ['src/components/ui/select.tsx', 'src/components/ClientCreateDialog.tsx', 'src/components/finance/PaymentFormDialog.tsx', 'src/components/finance/CommissionFormDialog.tsx', 'src/components/finance/CaseFinanceEditorDialog.tsx', 'src/styles/closeflow-event-form.css', 'src/styles/closeflow-task-form.css'],
  activePrimitives: ['src/components/ui/select.tsx'],
  cssSources: ['src/styles/closeflow-event-form.css', 'src/styles/closeflow-task-form.css'],
  tokenSources: ['src/styles/owners/closeflow-foundation.css'],
...
export const modalDialogVisualContract: VisualContract = {
  ...
  sourceFiles: ['src/components/ClientCreateDialog.tsx', 'src/components/ContextActionDialogs.tsx', 'src/components/finance/PaymentFormDialog.tsx', 'src/components/finance/CommissionFormDialog.tsx', 'src/components/finance/CaseFinanceEditorDialog.tsx', 'src/styles/closeflow-modal-visual-system.css', 'src/styles/closeflow-template-modal-actions.css'],
  activePrimitives: ['src/components/ContextActionDialogs.tsx'],
  cssSources: ['src/styles/closeflow-modal-visual-system.css', 'src/styles/closeflow-template-modal-actions.css'],
  tokenSources: ['src/styles/owners/closeflow-foundation.css'],
...
export const financeVisualContract: VisualContract = {
  ...
  sourceFiles: ['src/pages/Billing.tsx', 'src/styles/finance/closeflow-finance.css', 'src/styles/closeflow-billing.css', 'src/styles/closeflow-billing-taxonomy.css', 'src/components/finance/PaymentFormDialog.tsx', 'src/components/finance/CommissionFormDialog.tsx', 'src/components/finance/CaseFinanceEditorDialog.tsx', 'src/components/finance/CaseSettlementPanel.tsx'],
  activePrimitives: ['src/components/ui-system/ActionIcon.tsx'],
  cssSources: ['src/styles/finance/closeflow-finance.css', 'src/styles/closeflow-billing.css', 'src/styles/closeflow-billing-taxonomy.css'],
  tokenSources: ['src/styles/owners/closeflow-foundation.css'],
...
export const calendarTaskEventVisualContract: VisualContract = {
  ...
  sourceFiles: ['src/pages/Tasks.tsx', 'src/pages/TasksStable.tsx', 'src/pages/Calendar.tsx', 'src/styles/closeflow-calendar-selected-day-new-tile-v9.css', 'src/styles/closeflow-event-form.css', 'src/styles/closeflow-task-form.css', 'src/styles/operator-rail-tasks-pattern-stage228r1.css', 'src/styles/closeflow-tasks-right-rail-grouped-list-source-truth-stage178.css'],
  activePrimitives: ['src/components/ui-system/ActionIcon.tsx'],
  cssSources: ['src/styles/closeflow-calendar-selected-day-new-tile-v9.css', 'src/styles/closeflow-event-form.css', 'src/styles/closeflow-task-form.css'],
  tokenSources: ['src/styles/owners/closeflow-foundation.css'],
...
export const aiDraftVisualContract: VisualContract = {
  ...
  sourceFiles: ['src/pages/AiDrafts.tsx', 'src/pages/AdminAiSettings.tsx', 'src/components/LeadAiFollowupDraft.tsx', 'src/styles/closeflow-ai-drafts.css'],
  activePrimitives: ['src/ui-system/icons/SemanticIcon.tsx'],
  cssSources: ['src/styles/closeflow-ai-drafts.css'],
  tokenSources: ['src/styles/owners/closeflow-foundation.css'],
