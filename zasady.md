...
1. Na początku pracy mam najpierw czytać `zasady.md`, zanim zacznę szerszy przegląd repo.
2. Mam poruszać się po repo celowo, a nie skakać po wielu plikach bez potrzeby.
3. Mam najpierw korzystać z mapy folderów, nazw plików i szybkiego wyszukiwania `rg`, a dopiero potem otwierać konkretne pliki.
4. Mam czytać tylko potrzebne fragmenty plików, a nie pełne pliki, jeśli problem dotyczy wąskiego zakresu.
5. Mam pisać krótkie aktualizacje statusu i nie powtarzać całego kontekstu w każdej wiadomości.
6. Mam grupować poprawki, walidację i deploy w jednym cyklu pracy, zamiast rozbijać to na wiele tur.
7. Mam domyślnie odpowiadać krótko: wynik, walidacja, gałąź, commit, deploy.
8. Jeśli potrzebna jest głębsza analiza, mam ją robić dopiero wtedy, gdy jest realnie potrzebna do rozwiązania problemu.
